...
<h1 align="center">Tbot Backend Service tbot-esp32-server</h1>
...
Implemented using Python, Java, and Vue according to the <a href="https://ccnphfhqs21z.feishu.cn/wiki/M0XiwldO9iJwHikpXD5cEx71nKh">Tbot Communication Protocol</a><br/>
Support for MQTT+UDP protocol, Websocket protocol, MCP access point, voiceprint recognition, and knowledge base
</p>

<p align="center">
<a href="./docs/FAQ.md">FAQ</a>
· <a href="https://github.com/xinnan-tech/tbot-esp32-server/issues">Report Issues</a>
· <a href="./README.md#%E9%83%A8%E7%BD%B2%E6%96%87%E6%A1%A3">Deployment Docs</a>
· <a href="https://github.com/xinnan-tech/tbot-esp32-server/releases">Release Notes</a>
</p>
...
This project requires ESP32 hardware devices to work. If you have purchased ESP32-related hardware, successfully connected to Brother Xia's deployed backend service, and want to build your own `tbot-esp32` backend service independently, then this project is perfect for you.
...
OTA Interface Address: https://2662r3426b.vicp.fun/tbot/ota/
Websocket Interface Address: wss://2662r3426b.vicp.fun/tbot/v1/
```
...
If you are concerned about the latency of each component, please refer to the [Tbot Component Performance Test Report](https://github.com/xinnan-tech/tbot-performance-research), and test in your own environment following the test methods in the report.
...
|:---:|:---|:---:|:---:|
| Audio Interaction Test Tool | main》tbot-server》test》test_page.html | Open directly with Google Chrome | Tests audio playback and reception functions, verifies if Python-side audio processing is normal |
| Model Response Test Tool | main》tbot-server》performance_tester.py | Execute `python performance_tester.py` | Tests response speed of three core modules: ASR(speech recognition), LLM(large model), VLLM(vision model), TTS(speech synthesis) |
...
|:---:|:---|
| Core Architecture | Based on [MQTT+UDP gateway](https://github.com/xinnan-tech/tbot-esp32-server/blob/main/docs/mqtt-gateway-integration.md), WebSocket and HTTP servers, provides complete console management and authentication system |
...
## Product Ecosystem 👬
Tbot is an ecosystem. When using this product, you can also check out other [excellent projects](https://github.com/78/tbot-esp32/blob/main/README_zh.md#%E7%9B%B8%E5%85%B3%E5%BC%80%E6%BA%90%E9%A1%B9%E7%9B%AE) in this ecosystem
...
| <img src="./docs/images/logo_tenclass.png" width="160"> | [Tenclass](https://www.tenclass.com/) | Thanks to [Tenclass](https://www.tenclass.com/) for formulating standard communication protocols, multi-device compatibility solutions, and high-concurrency scenario practice demonstrations for the Tbot ecosystem; providing full-link technical documentation support for this project |
...
| <img src="./docs/images/logo_contributors.png" width="160"> | [Code Contributors](https://github.com/xinnan-tech/tbot-esp32-server/graphs/contributors) | Thanks to [all code contributors](https://github.com/xinnan-tech/tbot-esp32-server/graphs/contributors), your efforts have made the project more robust and powerful. |
