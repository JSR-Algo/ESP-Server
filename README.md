...
<h1 align="center">小智后端服务tbot-esp32-server</h1>

<p align="center">
本项目基于人机共生智能理论和技术研发智能终端软硬件体系<br/>为开源智能硬件项目
<a href="https://github.com/78/tbot-esp32">tbot-esp32</a>提供后端服务<br/>
...
· <a href="https://github.com/xinnan-tech/tbot-esp32-server/issues">反馈问题</a>
· <a href="./README.md#%E9%83%A8%E7%BD%B2%E6%96%87%E6%A1%A3">部署文档</a>
· <a href="https://github.com/xinnan-tech/tbot-esp32-server/releases">更新日志</a>
</p>
...
OTA接口地址: https://2662r3426b.vicp.fun/tbot/ota/
Websocket接口地址: wss://2662r3426b.vicp.fun/tbot/v1/
```
...
如果您关心各组件的耗时，请查阅[小智各组件性能测试报告](https://github.com/xinnan-tech/tbot-performance-research)，可按报告中的测试方法在您的环境中实际测试。
...
| 工具名称 | 位置 | 使用方法 | 功能说明 |
|:---:|:---|:---:|:---:|
| 音频交互测试工具 | main》tbot-server》test》test_page.html | 使用谷歌浏览器直接打开 | 测试音频播放和接收功能，验证Python端音频处理是否正常 |
| 模型响应测试工具 | main》tbot-server》performance_tester.py | 执行 `python performance_tester.py` | 测试ASR(语音识别)、LLM(大模型)、VLLM(视觉模型)、TTS(语音合成)三个核心模块的响应速度 |
...
| 功能模块 | 描述 |
|:---:|:---|
| 核心架构 | 基于[MQTT+UDP网关](https://github.com/xinnan-tech/tbot-esp32-server/blob/main/docs/mqtt-gateway-integration.md)、WebSocket、HTTP服务器，提供完整的控制台管理和认证系统 |
...
## 产品生态 👬
小智是一个生态，当你使用这个产品时，也可以看看其他在这个生态圈的[优秀项目](https://github.com/78/tbot-esp32/blob/main/README_zh.md#%E7%9B%B8%E5%85%B3%E5%BC%80%E6%BA%90%E9%A1%B9%E7%9B%AE)
...
| <img src="./docs/images/logo_contributors.png" width="160"> | [代码贡献者](https://github.com/xinnan-tech/tbot-esp32-server/graphs/contributors) | 感谢[所有代码贡献者](https://github.com/xinnan-tech/tbot-esp32-server/graphs/contributors)贡献者，你们的付出让项目更加健壮和强大。 |
