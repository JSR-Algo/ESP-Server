export default {
  ...
  'register.welcome': 'Willkommen bei TBOT',
  ...
  'paramManagement.updateSuccess': 'Aktualisierung erfolgreich. Einige Konfigurationen werden erst nach Neustart des TBOT-Server wirksam.',
  ...
  'roleConfig.voiceMode': 'Sprachmodus',
  'roleConfig.classicPipeline': 'Klassische Pipeline',
  'roleConfig.googleLiveApi': 'Google Live API',
  'roleConfig.googleLiveApiKey': 'Google-Live-API-Schlüssel',
  'roleConfig.googleLiveModel': 'Google-Live-Modell',
  'roleConfig.googleLiveVoiceName': 'Google-Live-Stimmenname',
  'roleConfig.googleLiveConnectTimeoutSec': 'Verbindungs-Timeout (Sek.)',
  'roleConfig.googleLiveRecvTimeoutSec': 'Empfangs-Timeout (Sek.)',
  'roleConfig.googleLiveInputFlushDelaySec': 'Input-Flush-Verzögerung (Sek.)',
  'roleConfig.googleLiveInputSampleRate': 'Input-Abtastrate (Hz)',
  'roleConfig.googleLiveOutputSampleRate': 'Output-Abtastrate (Hz)',
  'roleConfig.googleLiveEnableAudioInput': 'Audioeingang aktivieren',
  'roleConfig.googleLiveEnableAudioOutput': 'Audioausgabe aktivieren',
  'roleConfig.googleLiveNativeVoice': 'Native Stimme',
  'roleConfig.googleLiveBargeIn': 'Barge-In aktivieren',
  'roleConfig.googleLiveSendTranscriptEvents': 'Transkript-Ereignisse senden',
  'roleConfig.googleLiveSendLlmStateEvents': 'LLM-Statusereignisse senden',
  'roleConfig.googleLiveReconnectEnabled': 'Reconnect aktivieren',
  'roleConfig.googleLiveReconnectMaxRetries': 'Max. Reconnect-Versuche',
  'roleConfig.googleLiveReconnectBackoffMs': 'Reconnect-Backoff (ms)',
  'roleConfig.googleLiveFallback': 'Bei Fehler auf Classic zurückfallen',
  ...
  'roleConfig.tooltip.voiceMode': 'Wählen Sie zwischen bestehender Classic-Pipeline und Google-Live-Streaming-Provider',
  'roleConfig.tooltip.contextProvider': 'Wenn TBOT aktiviert wird, werden externe Systemdaten abgerufen und dynamisch in die Systemaufforderung des LLM eingefügt',
  ...
  'modelConfig.setDefaultSuccess': 'Standardmodell erfolgreich gesetzt, bitte starten Sie das TBOT-Server zeitnah manuell neu',
