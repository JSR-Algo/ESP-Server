export default {
  ...
  'course.editTitle': 'Sửa khoá học',
  'course.colKey': 'Mã khoá học',
  'course.colTitle': 'Tiêu đề',
  'course.colLocale': 'Ngôn ngữ',
  'course.colAgeBand': 'Độ tuổi',
  'course.colStatus': 'Trạng thái',
  'course.colQuality': 'Chất lượng',
  'course.colActions': 'Thao tác',
  'course.edit': 'Sửa',
  'course.delete': 'Xoá',
  'course.save': 'Lưu',
  'course.cancel': 'Huỷ',
  'course.empty': 'Chưa có khoá học',
  'course.keyPlaceholder': 'vd: w02-numbers',
  'course.required': 'Vui lòng nhập đủ các trường',
  'course.created': 'Đã tạo khoá học',
  'course.updated': 'Đã cập nhật khoá học',
  'course.deleted': 'Đã xoá khoá học',
  'course.deleteConfirm': 'Xoá khoá học "{key}"? Không thể hoàn tác.',
  'course.loadFail': 'Tải danh sách khoá học thất bại',
  'course.lessons': 'Bài học',
  'course.colType': 'Loại',
  'course.template': 'Mẫu',
  'course.clonedTag': 'Tuỳ chỉnh',
  'course.clone': 'Nhân bản',
  'course.markTemplate': 'Đặt làm mẫu',
  'course.unmarkTemplate': 'Bỏ làm mẫu',
  'course.markedTemplate': 'Đã đặt làm mẫu',
  'course.unmarkedTemplate': 'Đã bỏ làm mẫu',
  'course.cloneTitle': 'Nhân bản → tuỳ chỉnh',
  'course.cloneHint': 'Tạo bản sao tuỳ chỉnh có thể sửa từ "{source}" — bài học, bước và tài nguyên được copy sâu thành bản nháp.',
  'course.cloned': 'Đã nhân bản khoá học',
  'course.copyOf': 'Bản sao của {title}',
  'course.filterAll': 'Tất cả',
  'course.filterTemplate': 'Mẫu',
  'course.filterCustom': 'Tuỳ chỉnh',
  'course.statTotal': 'Tổng khoá học',
  'course.statTemplates': 'Mẫu',
  'course.statCustom': 'Khoá tuỳ chỉnh',
  'course.statPublished': 'Đã xuất bản',
  'course.insights': 'Trẻ em & chất lượng',
  'course.quickSearchPlaceholder': 'Tìm khoá học theo keyword, mã, tiêu đề, độ tuổi',
  'course.learnerFilterPlaceholder': 'Tên trẻ, sở thích hoặc nghề phụ huynh',
  'course.openLearners': 'Lọc theo trẻ/personality',
  'course.riskAll': 'Tất cả chất lượng',
  'course.qualityPreview': 'Chất lượng TB',
  'course.needsAttention': 'Khoá cần xử lý',
  'course.quality': 'Phân tích',
  'course.noQuality': 'Chưa có dữ liệu',
  'course.qualityLoadFail': 'Không tải được chất lượng khoá học nên điểm chất lượng và bộ lọc rủi ro tạm thời không dùng được. Danh sách khoá học vẫn hiển thị bình thường.',
  'course.qualityUnavailable': 'Không có sẵn',

  // Course insights: quản lý personality trẻ em + theo dõi chất lượng khoá học
  'insights.pageTitle': 'Trẻ em & chất lượng',
  'insights.backendHint': 'Dùng NestJS course insights API (/v1/admin/course-insights)',
  'insights.tabLearners': 'Personality trẻ em',
  'insights.tabQuality': 'Chất lượng khoá học',
  'insights.backCourses': 'Khoá học',
  'insights.refresh': 'Tải lại',
  'insights.search': 'Tìm kiếm',
  'insights.searchLearner': 'Tìm trẻ, phụ huynh, nghề nghiệp hoặc sở thích',
  'insights.searchLessonKeyword': 'Lọc bài học theo keyword, tiêu đề, khoá học hoặc tag',
  'insights.searchCourseKeyword': 'Lọc khoá học theo keyword hoặc mã khoá',
  'insights.child': 'Trẻ / phụ huynh',
  'insights.personality': 'Tín hiệu personality',
  'insights.progress': 'Tiến độ',
  'insights.noLearners': 'Chưa có hồ sơ trẻ',
  'insights.selectLearner': 'Chọn một hồ sơ trẻ',
  'insights.age': 'Tuổi',
  'insights.assignments': 'Lượt học',
  'insights.completed': 'Hoàn thành',
  ...
  'insights.previewLessons': 'Xem bài học phù hợp',
  'insights.rank': 'Hạng',
  'insights.lesson': 'Bài học',
  'insights.match': 'Mức phù hợp',
  'insights.reason': 'Lý do',
  'insights.difficultyFit': 'độ khó',
  'insights.durationFit': 'thời lượng',
  'insights.noPreview': 'Chưa có bài học phù hợp',
  'insights.loadLearnersFail': 'Tải hồ sơ trẻ thất bại',
  'insights.personalitySaved': 'Đã lưu personality',
  'insights.saveFail': 'Lưu personality thất bại',
  'insights.previewFail': 'Xem bài học phù hợp thất bại',
  'insights.qualityFail': 'Tải chất lượng khoá học thất bại',
  'insights.window7': '7 ngày gần nhất',
  'insights.window14': '14 ngày gần nhất',
  'insights.window30': '30 ngày gần nhất',
  'insights.window90': '90 ngày gần nhất',
  'insights.avgQuality': 'Chất lượng TB',
  'insights.totalAssignments': 'Lượt học',
  'insights.activeChildren': 'Trẻ đang học',
  'insights.needsAttention': 'Cần xử lý',
  'insights.riskLevel': 'Trạng thái',
  'insights.riskAll': 'Tất cả trạng thái',
  'insights.riskAttention': 'Cần xử lý',
  'insights.riskWatch': 'Cần theo dõi',
  'insights.riskHealthy': 'Ổn định',
  'insights.qualityScore': 'Chất lượng',
  'insights.scoreBreakdown': 'Tách điểm',
  'insights.completionShort': 'Xong',
  'insights.successShort': 'Đúng',
  'insights.personalizationShort': 'Hợp',
  'insights.coverage': 'Bài có personality',
  'insights.completionRate': 'Hoàn thành',
  'insights.successRate': 'Đúng theo bước',
  'insights.avgDuration': 'Thời lượng',
  'insights.failed': 'Lỗi',
  'insights.running': 'Đang chạy',
  'insights.issues': 'Vấn đề',
  'insights.noIssues': 'Không có vấn đề',
  'insights.issue.no-activity': 'chưa có hoạt động',
  'insights.issue.low-completion': 'hoàn thành thấp',
  'insights.issue.low-success': 'đúng thấp',
  'insights.issue.low-personalization': 'personality thấp',
  'insights.issue.has-failures': 'có lượt lỗi',
  'insights.lastActivity': 'Hoạt động cuối',
  'insights.noQuality': 'Chưa có dữ liệu chất lượng khoá học',

  // Admin lesson-monitoring (NestJS API qua proxy /nestjs)
  'monitoring.pageTitle': 'Theo dõi bài học',
  'monitoring.backendHint': 'Dùng NestJS API (/v1/admin/lesson-monitoring) qua proxy',
  'monitoring.refresh': 'Tải lại',
  'monitoring.filterKeyword': 'Keyword: tên trẻ, thiết bị, bài học hoặc khoá học',
  'monitoring.filterDeviceId': 'Lọc theo mã thiết bị',
  'monitoring.filterChildId': 'Lọc theo mã trẻ',
  ...
  'monitoring.colSteps': 'Bước',
  'monitoring.colStartedAt': 'Bắt đầu',
  'monitoring.colCompletedAt': 'Hoàn thành',
  'monitoring.colActions': 'Thao tác',
  'monitoring.view': 'Xem',
  ...
  'monitoring.evStep': 'Bước',
  'monitoring.evOutcome': 'Kết quả',
  'monitoring.evOccurredAt': 'Thời điểm',
  'monitoring.evEmpty': 'Chưa có sự kiện',
  'monitoring.close': 'Đóng',

  // Lesson / step / asset / publish (NestJS authoring API qua proxy /nestjs)
  'lesson.pageTitle': 'Bài học',
  'lesson.createBtn': 'Tạo bài học',
  'lesson.createTitle': 'Tạo bài học',
  'lesson.colKey': 'Mã bài học',
  'lesson.colTitle': 'Tiêu đề',
  'lesson.colVersion': 'Phiên bản',
  'lesson.colStatus': 'Trạng thái',
  'lesson.colActions': 'Thao tác',
  'lesson.editSteps': 'Sửa bước',
  'lesson.delete': 'Xoá',
  'lesson.empty': 'Chưa có bài học',
  'lesson.keyPlaceholder': 'vd: w02-d01-run-say-it',
  'lesson.created': 'Đã tạo bài học',
  'lesson.deleted': 'Đã xoá bài học',
  'lesson.deleteConfirm': 'Xoá bài học "{key}"? Không thể hoàn tác.',
  'lesson.newVersion': 'Tạo bản sửa (version mới)',
  'lesson.newVersionHint': 'Bài học đã xuất bản không thể sửa trực tiếp. Thao tác này sao chép bài học thành một bản nháp mới để bạn chỉnh sửa; khi xuất bản, bản mới sẽ thay thế bản đang chạy.',
  'lesson.newVersionConfirm': 'Tạo phiên bản mới có thể chỉnh sửa của "{key}"? Khi xuất bản, bản mới sẽ thay thế bài học đang chạy.',
  'lesson.newVersionCreated': 'Đã tạo bản nháp v{v} — chỉnh sửa rồi xuất bản để thay thế bản đang chạy',
  'lesson.statTotal': 'Tổng bài học',
  'lesson.statMonitorable': 'Có theo dõi',
  'lesson.statPersonalized': 'Sẵn sàng personality',
  'lesson.statDuration': 'Thời lượng dự kiến',
  'lesson.filterKeyword': 'Tìm bài học hoặc tag',
  'lesson.filterStatus': 'Trạng thái',
  'lesson.filterType': 'Loại',
  'lesson.filterPersonality': 'Tag personality',
  'lesson.filterDifficulty': 'Độ khó',
  'lesson.filterMonitorable': 'Theo dõi',
  'lesson.clearFilters': 'Xóa bộ lọc',
  'lesson.colLessonType': 'Loại',
  'lesson.colPersonalityTags': 'Tag personality',
  'lesson.colDifficulty': 'Độ khó',
  'lesson.colDuration': 'Thời lượng',
  'lesson.colMonitorable': 'Monitor',
  'lesson.noTags': 'Chưa có tag',
  'lesson.monitorableYes': 'Có',
  'lesson.monitorableNo': 'Không',
  'lesson.editMetadata': 'Metadata',
  'lesson.editMetadataTitle': 'Sửa metadata bài học',
  'lesson.metadataSaved': 'Đã lưu metadata bài học',
  'lesson.topicTagsPlaceholder': 'animals, farm, visual',
  'lesson.durationHelp': 'giây, dùng cho xếp hạng theo attention span',
  'lesson.ageBandUnenforced': 'Nhóm tuổi này không có tuổi bắt đầu nên giới hạn độ tuổi sẽ KHÔNG được áp dụng — mọi trẻ đều có thể được giao bài học này. Hãy dùng dạng như 4-6.',
  'lesson.ageBandCustom': 'Nhóm tuổi tuỳ chỉnh — giới hạn độ tuổi sẽ chặn trẻ dưới {min} tuổi.',
  'lesson.monitor': 'Theo dõi',
  'lesson.assignToChild': 'Giao cho trẻ',
  'lesson.assignDialogTitle': 'Giao bài học cho trẻ',
  'lesson.assignChildPlaceholder': 'Tìm trẻ theo tên hoặc email phụ huynh',
  'lesson.assignDevice': 'Thiết bị',
  'lesson.assignSerial': 'Serial',
  'lesson.assignAvailability': 'Trạng thái',
  'lesson.assignCurrent': 'Bài đang giao',
  'lesson.assignNoCurrent': 'Chưa có bài đang chạy',
  'lesson.assignNoDevices': 'Không có robot active phù hợp',
  'lesson.assignChooseChild': 'Chọn trẻ để tải robot',
  'lesson.assignAvailable': 'Có thể giao',
  'lesson.assignAlready': 'Đã giao',
  'lesson.assignBusy': 'Đang bận',
  'lesson.assignReuse': 'Dùng lại',
  'lesson.assign': 'Giao',
  'lesson.assignLearnersLoadFail': 'Tải danh sách trẻ thất bại',
  'lesson.assignEligibilityLoadFail': 'Tải trạng thái robot thất bại',
  'lesson.assignCreatedSuccess': 'Đã tạo assignment',
  'lesson.assignAlreadySuccess': 'Assignment cho trẻ và bài học này đã tồn tại',
  'lesson.assignConflict': 'Robot đang bận. Đã tải lại trạng thái; mở Theo dõi để xem chi tiết.',
  'lesson.assignFailed': 'Giao bài thất bại',
  'lesson.assignUncertainRetry': 'Chưa chắc kết quả giao bài. Đã tải lại trạng thái; có thể thử lại.',
  'lesson.loadFail': 'Tải danh sách bài học thất bại',
  'lesson.steps': 'Các bước',
  'lesson.stepType': 'Loại bước',
  'lesson.prompt': 'Lời nhắc',
  'lesson.promptEditorLabel': 'Lời nhắc của bước',
  'lesson.promptEditorHint': 'Chỉnh sửa hướng dẫn được hiển thị và đọc cho bước này. Tối đa 500 ký tự.',
  'lesson.stepSaved': 'Đã lưu bước vào bản nháp bài học.',
  ...
  'lesson.visualTripleTitle': 'Background, object và video robot của bài học',
  ...
  'lesson.addStep': 'Thêm bước',
  'lesson.deleteStep': 'Xoá',
  'lesson.deleteStepConfirm': 'Xoá bước "{key}"?',
  'lesson.noSteps': 'Chưa có bước nào',
  'lesson.draftOnly': 'Chỉ sửa được các bước khi bài học ở trạng thái nháp.',
  'lesson.stepRequired': 'Cần loại bước, lời nhắc và chủ đề',
  'lesson.assets': 'Tải tài nguyên',
  'lesson.pickImage': 'Chọn ảnh',
  'lesson.uploadAsset': 'Tải lên',
  'lesson.assetHint': 'Bundle chơi được cần backgroundScene + teachingObject (critical)',
  'lesson.uploadOk': 'Đã tải tài nguyên (digest do server tính)',
  ...
  'lesson.validate': 'Kiểm tra',
  'lesson.validOk': 'Hợp lệ cho: {profiles}',
  'lesson.validFail': 'Kiểm tra thất bại',
  'lesson.previewManifest': 'Xem manifest',
  'lesson.checksum': 'checksum (server)',
  'lesson.publish': 'Xuất bản',
  'lesson.publishConfirm': 'Xuất bản bài học này? Bài đã xuất bản không sửa được.',
  'lesson.publishedMsg': 'Đã xuất bản v{v} · checksum {checksum}',
  'lesson.publishedOfflineSyncContinues': 'Đã xuất bản v{v} · checksum {checksum}. Đồng bộ SD ngoại tuyến tiếp tục chạy bất đồng bộ.',
  'lesson.sdSyncTitle': 'Triển khai thế hệ bài học',
  'lesson.sdSyncCounters': 'Số liệu triển khai thế hệ bài học',
  'lesson.sdSyncMetadata': 'Thông tin triển khai thế hệ',
  'lesson.sdSyncGeneration': 'Thế hệ',
  'lesson.sdSyncCurriculumLessons': 'Bài học chương trình',
  'lesson.sdSyncTotalPacks': 'Tổng gói',
  'lesson.sdSyncConnected': 'Đang kết nối',
  'lesson.sdSyncCurrent': 'Đã cập nhật',
  'lesson.sdSyncRetrying': 'Đang thử lại',
  'lesson.sdSyncFailed': 'Lỗi',
  'lesson.sdSyncRetryAction': 'Thử triển khai lại',
  'lesson.sdSyncRetryQueued': 'Đã xếp hàng tạo lại dữ liệu bài học và dịch vụ robot đã bắt đầu thử lại.',
  'lesson.sdSyncRetryQueuedDeferred': 'Đã xếp hàng tạo lại dữ liệu bài học; dịch vụ robot sẽ sớm thử chuẩn bị lại.',
  'lesson.sdSyncRetryQueuedUnavailable': 'Đã xếp hàng tạo lại dữ liệu bài học; dịch vụ robot hiện chưa kết nối được và sẽ tiếp tục khi hoạt động lại.',
  'lesson.sdSyncRetryNotQueued': 'Chưa thể xếp hàng tạo lại dữ liệu bài học.',
  ...
  'lesson.sdSyncMaterializationState': 'Chuẩn bị dữ liệu',
  'lesson.sdSyncLastBuild': 'Cập nhật bản dựng cuối',
  'lesson.sdSyncLastPoll': 'Lần kiểm tra cuối',
  'lesson.sdSyncLastMaterialized': 'Lần chuẩn bị xong cuối',
  'lesson.sdSyncLastErrorCode': 'Mã lỗi cuối',
  'lesson.sdSyncUnavailable': 'Không có',
  'lesson.sdSyncStateAllCurrent': 'Robot kết nối đã cập nhật',
  'lesson.sdSyncStateAllCurrentDescription': 'Mọi robot đang kết nối đều báo đã nhận thế hệ được chấp nhận mới nhất.',
  'lesson.sdSyncStateNoConnected': 'Không có robot kết nối',
  'lesson.sdSyncStateNoConnectedDescription': 'Hiện không có robot kết nối để xác nhận đợt triển khai.',
  'lesson.sdSyncStateBuilding': 'CMS đang tạo bản dựng',
  'lesson.sdSyncStateBuildingDescription': 'CMS đang chuẩn bị một thế hệ bài học mới hơn.',
  'lesson.sdSyncStateMaterializing': 'Đang chuẩn bị dữ liệu',
  'lesson.sdSyncStateMaterializingDescription': 'Dịch vụ robot đang chuẩn bị thế hệ được chấp nhận để phân phối.',
  'lesson.sdSyncStateRetrying': 'Đang thử lại',
  'lesson.sdSyncStateRetryingDescription': 'Dịch vụ hoặc một hay nhiều robot đang kết nối đang thử lại.',
  'lesson.sdSyncStateFailed': 'Cần kiểm tra',
  'lesson.sdSyncStateFailedDescription': 'Bản dựng CMS hoặc ít nhất một robot đang kết nối báo lỗi.',
  'lesson.sdSyncStateGenerationMismatch': 'Thế hệ chưa khớp',
  'lesson.sdSyncStateGenerationMismatchDescription': 'Thế hệ CMS và thế hệ dịch vụ robot chấp nhận chưa khớp.',
  'lesson.sdSyncStateRollingOut': 'Đang triển khai',
  'lesson.sdSyncStateRollingOutDescription': 'Một số robot đang kết nối chưa nhận thế hệ được chấp nhận.',
  'lesson.sdSyncStatePolling': 'Đang chờ chuẩn bị dữ liệu',
  'lesson.sdSyncStatePollingDescription': 'Dịch vụ robot đang kiểm tra hoặc xác thực thế hệ CMS mới nhất.',
  'lesson.sdSyncBuildIdle': 'Rảnh',
  'lesson.sdSyncBuildPending': 'Đang chờ',
  'lesson.sdSyncBuildBuilding': 'Đang dựng',
  'lesson.sdSyncBuildFailed': 'Lỗi',
  'lesson.sdSyncBuildWithPending': '{state} ({count} đang chờ)',
  'lesson.sdSyncMaterializationEmpty': 'Chờ thế hệ đầu tiên',
  'lesson.sdSyncMaterializationPolling': 'Đang kiểm tra',
  'lesson.sdSyncMaterializationMaterializing': 'Đang chuẩn bị',
  'lesson.sdSyncMaterializationRetryWait': 'Đang chờ thử lại',
  'lesson.sdSyncMaterializationReady': 'Sẵn sàng',
  'lesson.publishReadiness': 'Bằng chứng xuất bản',
  'lesson.flattenedDerivativeTitle': 'Mức sẵn sàng media Robot Flattened',
  'lesson.flattenedDerivativeHint': 'Các pha cinematic renderer-v4 do máy chủ kết xuất và bắt buộc trước khi xuất bản.',
  'lesson.flattenedDerivativeRefresh': 'Làm mới trạng thái',
  'lesson.flattenedDerivativeLoading': 'Đang kiểm tra trạng thái derivative chính thức…',
  'lesson.flattenedDerivativeNotRequired': 'Bài học này không yêu cầu pha flattened renderer-v4.',
  'lesson.flattenedDerivativeStatusFailed': 'Không tải được trạng thái derivative: {reason}',
  'lesson.flattenedDerivativeServerFailed': 'Kết xuất trên máy chủ thất bại ({code}). Hãy làm mới sau khi sửa nguồn hoặc worker.',
  'lesson.flattenedDerivativePreviewFailed': 'Derivative đã sẵn sàng trên máy chủ nhưng trình duyệt không xem trước được. Hãy kiểm tra quyền truy cập media hoặc CORS; trạng thái máy chủ không thay đổi.',
  'lesson.flattenedDerivativePublishConflict': 'Xuất bản bị chặn vì media flattened hiện tại không còn sẵn sàng. Trạng thái đã được làm mới; hãy chờ mọi pha chuyển sang sẵn sàng.',
  'lesson.flattenedDerivativeState.not-requested': 'Chưa yêu cầu',
  'lesson.flattenedDerivativeState.processing': 'Đang xử lý',
  'lesson.flattenedDerivativeState.ready': 'Sẵn sàng',
  'lesson.flattenedDerivativeState.failed': 'Thất bại',
  'lesson.flattenedDerivativeState.stale': 'Đã cũ',
  'lesson.serverValidation': 'Kiểm tra chính thức từ máy chủ',
  'lesson.validationMissing': 'CHƯA CHẠY',
  'lesson.proofStale': 'ĐÃ CŨ',
  'lesson.validationProfiles': 'Profile',
  'lesson.validationNoFindings': 'Máy chủ không báo lỗi hoặc cảnh báo.',
  'lesson.validationRunHint': 'Chạy kiểm tra sau khi lưu mọi thay đổi. Kết quả sẽ luôn hiển thị tại đây.',
  'lesson.budgetDownload': 'Tải xuống',
  'lesson.budgetAssets': 'Riêng / dùng chung',
  'lesson.budgetPsram': 'PSRAM cao nhất',
  'lesson.budgetOffline': 'Ngoại tuyến',
  'lesson.budgetPaths': 'Mọi nhánh',
  'lesson.publishReviewTitle': 'Duyệt phiên bản bất biến',
  'lesson.publishImmutableWarning': 'Xuất bản sẽ tạo phiên bản đã duyệt. Phiên bản đã xuất bản trước đó phải giữ nguyên từng byte và từng ghim tài nguyên.',
  'lesson.publishFirstWarning': 'Xuất bản sẽ chuyển bản nháp v1 đã duyệt này tại chỗ. Các byte manifest và ghim tài nguyên mọi profile phải khớp bằng chứng đã duyệt.',
  'lesson.publishSourceEvidence': 'Phiên bản gốc đã xuất bản',
  'lesson.publishFirstSourceEvidence': 'Các byte bản nháp phiên bản đầu đã duyệt',
  'lesson.publishTargetEvidence': 'Phiên bản đích đã duyệt',
  'lesson.publishSimulationEvidence': 'Hoàn tất mô phỏng',
  'lesson.publishSourcePins': 'Ghim tài nguyên và số byte chính xác của bản gốc',
  'lesson.publishFirstPins': 'Ghim tài nguyên và số byte chính xác của bản nháp v1 đã duyệt',
  'lesson.statusPass': 'ĐẠT',
  'lesson.statusFail': 'LỖI',
  'lesson.statusReady': 'SẴN SÀNG',
  'lesson.statusCheck': 'CẦN KIỂM TRA',
  'lesson.publishFieldLesson': 'Bài học',
  'lesson.publishFieldVersion': 'Phiên bản',
  'lesson.publishFieldChecksum': 'Checksum',
  'lesson.publishFieldPins': 'Ghim',
  'lesson.publishFieldBytes': 'Số byte',
  'lesson.publishFieldSteps': 'Các bước',
  'lesson.publishFieldAssets': 'Tài nguyên',
  'lesson.publishFieldProfile': 'Profile',
  'lesson.publishFieldStage': 'Khung hình',
  'lesson.publishFieldEtag': 'ETag',
  'lesson.publishFieldProof': 'bằng chứng',
  'lesson.publishOriginalPass': 'Tính bất biến bản gốc: ĐẠT',
  'lesson.publishOriginalFail': 'Tính bất biến bản gốc: LỖI',
  'lesson.publishFirstSourcePass': 'Các byte bản nháp v1 đã duyệt được giữ nguyên: ĐẠT',
  'lesson.publishFirstSourceFail': 'Các byte bản nháp v1 đã duyệt được giữ nguyên: LỖI',
  'lesson.publishTargetPass': 'Danh tính bản đích đã xuất bản: ĐẠT',
  'lesson.publishTargetFail': 'Danh tính bản đích đã xuất bản: LỖI',
  'lesson.publishTargetSummary': 'v{version} · {checksum} · {count} tài nguyên',
  'lesson.publishChecksumUnavailable': 'không có checksum',
  'lesson.publishCompletionUnavailable': 'không có sự kiện hoàn tất',
  'lesson.publishEvidenceIdentityMissing': 'Thiếu danh tính bài học cho bằng chứng.',
  'lesson.publishManifestEvidenceMalformed': 'Bằng chứng manifest chính thức không hợp lệ.',
  'lesson.publishAssetEvidenceMalformed': 'Bằng chứng tài nguyên chính thức của mọi profile không hợp lệ.',
  'lesson.publishTargetIdentityMalformed': 'Phản hồi danh tính bản đích đã xuất bản không hợp lệ.',
  'lesson.publishFailed': 'Xuất bản thất bại: {reason}',
  'lesson.publishResponseMalformed': 'Phản hồi xuất bản không hợp lệ; cần đối soát trạng thái chính thức.',
  'lesson.publishReconciling': 'Đang đối soát trạng thái xuất bản chính thức…',
  ...
  'lesson.publishDiffOriginalChecksum': 'Checksum bản gốc thay đổi: {before} → {after}.',
  'lesson.publishDiffOriginalRowChecksum': 'Checksum trên hàng bài học gốc đã thay đổi hoặc không còn khớp manifest chính thức.',
  'lesson.publishDiffOriginalManifest': 'Các byte manifest bản gốc đã thay đổi.',
  'lesson.publishDiffOriginalAssets': 'Profile, ghim, digest, đường dẫn, metadata hoặc số byte tài nguyên gốc đã thay đổi.',
  'lesson.publishDiffOriginalBytes': 'Số byte tài nguyên gốc thay đổi: {before} → {after}.',
  'lesson.publishDiffOriginalUnavailable': 'Không thể kiểm tra bản gốc: {reason}',
  'lesson.publishDiffTargetMissing': 'Thiếu bằng chứng bản đích đã xuất bản.',
  'lesson.publishDiffTargetIdentity': 'Danh tính bản đích đã xuất bản không khớp bản nháp đã duyệt.',
  'lesson.publishDiffTargetStatus': 'Bài học đích chính thức chưa ở trạng thái đã xuất bản.',
  'lesson.publishDiffTargetVersion': 'Phiên bản bản đích không khớp phiên bản đã duyệt hoặc phản hồi xuất bản.',
  'lesson.publishDiffTargetRowChecksumMissing': 'Thiếu checksum trên hàng bản đích đã xuất bản.',
  'lesson.publishDiffTargetChecksum': 'Checksum bản đích, phản hồi xuất bản và bản xem trước đã duyệt không khớp.',
  'lesson.publishDiffTargetUnavailable': 'Không thể kiểm tra bản đích đã xuất bản: {reason}',
  'lesson.publishImmutableAck': 'Tôi đã duyệt v{target} và hiểu rằng phiên bản nguồn v{source} là bất biến.',
  'lesson.publishFirstAck': 'Tôi đã duyệt lần xuất bản đầu của v{target} và các byte bản nháp chính xác.',
  'lesson.publishReviewedVersion': 'Xuất bản phiên bản đã duyệt',
  'lesson.publishOriginalMissing': 'Không xác định được các hàng bản nháp/nguồn chính thức. Đã chặn xuất bản.',
  'lesson.publishUncertain': 'Kết quả xuất bản chưa chắc chắn. Không thử lại trước khi tải lại trạng thái bài học chính thức.',
  'lesson.publishVerified': 'Đã xuất bản và kiểm tra độc lập rằng phiên bản gốc không đổi.',
  'lesson.publishVerificationFailed': 'Đã xuất bản nhưng kiểm tra tính bất biến của phiên bản gốc thất bại hoặc chưa đầy đủ.',
  'lesson.publishFirstVerified': 'Đã xuất bản v1 và kiểm tra độc lập rằng các byte bản nháp đã duyệt không đổi.',
  'lesson.publishFirstVerificationFailed': 'Đã xuất bản v1 nhưng kiểm tra byte bản nháp đã duyệt thất bại hoặc chưa đầy đủ.',
  // Hộp thoại soạn bước (từ vựng + các trường chi tiết)
  'lesson.addStepTitle': 'Thêm bước',
  'lesson.stepTypePassive': 'Bị động (tự chuyển tiếp)',
  'lesson.stepTypeInteractive': 'Tương tác (chờ trẻ)',
  'lesson.subjectLabel': 'Từ vựng / chủ đề',
  'lesson.helperText': 'Gợi ý trên màn hình',
  'lesson.l1TransferHint': 'Gợi ý chuyển di L1',
  'lesson.choices': 'Các lựa chọn đáp án',
  'lesson.choiceLabel': 'Lựa chọn',
  'lesson.choiceCorrect': 'Đúng',
  'lesson.addChoice': 'Thêm lựa chọn',
  'lesson.removeChoice': 'Xoá',
  'lesson.blankHint': 'Với dạng điền vào chỗ trống, viết chỗ trống là ___ trong lời nhắc.',
  'lesson.fillBlankNeedsChoices': 'fillBlank cần ít nhất 2 lựa chọn và đúng một lựa chọn được đánh dấu đúng.',
  'lesson.choiceLabelRequired': 'Mỗi lựa chọn cần có nhãn.',
  'lesson.cancel': 'Huỷ',
  'lesson.save': 'Lưu',
  'lesson.colChoices': 'Lựa chọn',
  // Trình quản lý tài nguyên
  'lesson.layer': 'Lớp',
  'lesson.role': 'Vai trò',
  'lesson.assetKey': 'Khóa tài nguyên',
  'lesson.critical': 'Bắt buộc',
  'lesson.pose': 'Tư thế robot',
  'lesson.poseTeach': 'teach',
  'lesson.poseListening': 'listening',
  'lesson.poseThinking': 'thinking',
  'lesson.poseCelebrate': 'celebrate',
  'lesson.layerBackground': 'Cảnh nền',
  'lesson.layerTeachingObject': 'Vật thể dạy học',
  'lesson.layerRobotOverlay': 'Lớp phủ robot',
  'lesson.assetList': 'Đã tải trong phiên này',
  'lesson.assetPreview': 'Xem trước',
  'lesson.assetSessionOnly': 'Danh sách chỉ trong phiên (chưa có API liệt kê tài nguyên).',
  'lesson.assetKeyRequired': 'Cần có khóa tài nguyên.',
  'lesson.uploadReject415': 'espTft chỉ chấp nhận PNG/JPEG.',
  // Quản lý tài nguyên (danh sách từ server / xoá / thay thế)
  'lesson.refresh': 'Tải lại',
  'lesson.assetListEmpty': 'Chưa tải tài nguyên nào.',
  'lesson.noPreview': 'Không xem trước',
  'lesson.replaceAsset': 'Thay thế',
  'lesson.assetDeleteConfirm': 'Xoá tài nguyên này khỏi bundle?',
  'lesson.assetDeleted': 'Đã xoá tài nguyên',
  'lesson.assetDeleteInUse': 'Không thể xoá {assetKey}: vẫn đang được dùng ở bước {steps}. Hãy gỡ liên kết ở đó trước.',
  'lesson.stepSaveConflictChanged': 'Bước {key} đã bị thay đổi trên máy chủ trong lúc bạn chỉnh sửa. Bản nháp của bạn được giữ lại và trình soạn thảo đã tải lại — hãy xem lại rồi lưu lần nữa để ghi đè.',
  'lesson.stepSaveConflictRemoved': 'Bước {key} không còn tồn tại trên máy chủ. Bản nháp được giữ lại nhưng không thể lưu vào bước này.',
  'lesson.stepSaveConflictCheckFailed': 'Không xác minh được bước chưa bị thay đổi trước khi lưu ({reason}). Chưa ghi gì cả.',
  'lesson.unsavedLeaveTitle': 'Thay đổi chưa lưu',
  'lesson.unsavedLeaveBody': 'Bài học này có thay đổi bước chưa lưu. Rời đi bây giờ sẽ mất các thay đổi đó.',
  'lesson.unsavedLeaveDiscard': 'Bỏ thay đổi và rời đi',
  'lesson.unsavedLeaveStay': 'Ở lại',
  'lesson.sharedVisual': 'Hình ảnh dùng chung',
  'lesson.sharedVisualFilter': 'Lọc theo khóa tài nguyên',
  'lesson.sharedVisualEmpty': 'Không có hình ảnh dùng chung phù hợp.',
  'lesson.sharedImpactTitle': 'Xem ảnh hưởng của hình ảnh dùng chung',
  'lesson.sharedImpactSourceKey': 'Khóa tài nguyên nguồn',
  'lesson.sharedImpactChecksum': 'Checksum nguồn',
  'lesson.sharedImpactCloneKey': 'Khóa bản sao cho bản nháp',
  'lesson.sharedImpactUsages': 'Nơi sử dụng theo máy chủ',
  'lesson.sharedImpactLessonKey': 'Khóa bài học',
  'lesson.sharedImpactLesson': 'Bài học',
  'lesson.sharedImpactVersion': 'Phiên bản',
  'lesson.sharedImpactStatus': 'Trạng thái',
  'lesson.sharedImpactProfile': 'Profile',
  'lesson.sharedImpactUsageKey': 'Khóa đang ghim',
  'lesson.sharedImpactNoUsages': 'Máy chủ không báo cáo nơi sử dụng nào khác.',
  'lesson.sharedImpactLocalSteps': 'Các bước bị ảnh hưởng trong bản nháp này',
  'lesson.sharedImpactNoLocalSteps': 'Không có bước nào trong bản nháp đang tham chiếu khóa này.',
  ...
  'lesson.renderExpressionHint': 'Trên thiết bị chỉ thay đổi khuôn mặt robot. Listening và Thinking hiển thị cùng một khuôn mặt; nền/vật thể/tư thế được soạn nhưng firmware hiện tại chưa hiển thị.',
  // Từ vựng có cấu trúc (lưu trong stepBody.vocab; chỉ là metadata cho tác giả)
  'lesson.vocabSection': 'Từ vựng',
  'lesson.vocabWord': 'Từ',
  'lesson.vocabIpa': 'IPA / phiên âm',
  'lesson.vocabPos': 'Từ loại',
  'lesson.vocabTranslation': 'Bản dịch (vi)',
  'lesson.vocabDefinition': 'Định nghĩa',
  'lesson.vocabExamples': 'Ví dụ',
  'lesson.vocabExampleText': 'Câu ví dụ',
  'lesson.vocabExampleTranslation': 'Bản dịch (tuỳ chọn)',
  'lesson.addExample': 'Thêm ví dụ',
  'lesson.removeExample': 'Xoá',
  'lesson.pos_noun': 'danh từ',
  'lesson.pos_verb': 'động từ',
  'lesson.pos_adjective': 'tính từ',
  'lesson.pos_adverb': 'trạng từ',
  'lesson.pos_pronoun': 'đại từ',
  'lesson.pos_preposition': 'giới từ',
  'lesson.pos_conjunction': 'liên từ',
  'lesson.pos_interjection': 'thán từ',
  'lesson.pos_determiner': 'từ hạn định',
  // Trình soạn Cảnh theo từng bước
  'lesson.sceneSection': 'Cảnh',
  'lesson.sceneNone': 'Không',
  'lesson.sceneNoAssets': 'Tải tài nguyên nền / vật thể dạy học ở dưới để soạn cảnh.',
  'lesson.backgroundScene': 'Cảnh nền',
  'lesson.altCaption': 'Chú thích thay thế',
  'lesson.fit': 'Cách hiển thị',
  'lesson.teachingObject': 'Vật thể dạy học',
  'lesson.primaryWord': 'Từ chính',
  'lesson.supportWords': 'Từ hỗ trợ',
  'lesson.placement': 'Vị trí',
  'lesson.focusTarget': 'Vùng tiêu điểm (vùng chạm) — chỉ bước model',
  'lesson.addWindow': 'Thêm cửa sổ',
  'lesson.successUtterance': 'Câu khi đúng',
  'lesson.missUtterance': 'Câu khi sai',
  'lesson.focusHint': 'x/y/w/h được giới hạn trong 0–1 và mỗi cửa sổ phải có tStart < tEnd (nếu không sẽ lỗi khi xuất bản).',
  'lesson.timeoutSec': 'Hết giờ (giây)',

  // Đăng nhập tác giả NestJS (per-user)
  'nestLogin.title': 'Đăng nhập tác giả (NestJS)',
  'nestLogin.hint': 'Hành động biên soạn sẽ gắn với admin này. Nếu không, dùng token dev dùng chung.',
  'nestLogin.email': 'Email',
  'nestLogin.password': 'Mật khẩu',
  'nestLogin.signIn': 'Đăng nhập tác giả',
  'nestLogin.signedIn': 'Đã đăng nhập tác giả',
  'nestLogin.required': 'Cần email và mật khẩu',
  'nestLogin.mfaHint': 'Nhập mã 6 số từ ứng dụng xác thực.',
  'nestLogin.code': 'Mã 6 số',
  'nestLogin.codeRequired': 'Nhập mã 6 số',
  'nestLogin.verify': 'Xác minh',
  'nestLogin.ok': 'Đã đăng nhập với vai trò {role}',
  ...
  'register.welcome': 'Chào mừng đến với TBOT',
  ...
  'device.searchPlaceholder': 'Tìm model, địa chỉ Mac hoặc tên trẻ',
  'device.childNamePlaceholder': 'Chọn tên trẻ cho thiết bị',
  'device.useChildName': 'Dùng tên trẻ',
  'device.applyChildProfile': 'Áp dụng hồ sơ trẻ',
  'device.selectChildNameFirst': 'Chọn tên trẻ trước',
  'device.childNameApplied': 'Đã đổi tên thiết bị theo tên trẻ',
  'device.childProfileApplied': 'Đã cập nhật thiết bị theo hồ sơ trẻ',
  'device.childProfile': 'Hồ sơ trẻ',
  'device.childName': 'Tên trẻ',
  'device.childAge': 'Tuổi',
  'device.childInterests': 'Sở thích, cách nhau bằng dấu phẩy',
  'device.learningStyle': 'Cách học',
  'device.vocabularyLevel': 'Mức từ vựng',
  'device.parentCareer': 'Chủ đề nghề nghiệp phụ huynh',
  'device.yearsOld': 'tuổi',
  'device.childNameTooLong': 'Tên trẻ không được vượt quá 64 ký tự',
  'device.childAgeInvalid': 'Tuổi trẻ phải từ 1 đến 18',
  'device.childProfileSaved': 'Đã lưu hồ sơ trẻ cho thiết bị',
  'device.childProfileSaveFailed': 'Không thể lưu hồ sơ trẻ cho thiết bị',
  ...
  'paramManagement.updateSuccess': 'Cập nhật thành công. Một số cấu hình chỉ có hiệu lực sau khi khởi động lại module TBOT server.',
  ...
  'roleConfig.googleLiveRecvTimeoutSec': 'Timeout nhận (giây)',
  'roleConfig.googleLiveInputFlushDelaySec': 'Độ trễ flush input (giây)',
  'roleConfig.googleLiveInputSampleRate': 'Tần số lấy mẫu input (Hz)',
  'roleConfig.googleLiveOutputSampleRate': 'Tần số lấy mẫu output (Hz)',
  'roleConfig.googleLiveEnableAudioInput': 'Bật âm thanh đầu vào',
  'roleConfig.googleLiveEnableAudioOutput': 'Bật âm thanh đầu ra',
  'roleConfig.googleLiveNativeVoice': 'Giọng native',
  'roleConfig.googleLiveBargeIn': 'Bật barge-in',
  'roleConfig.googleLiveSendTranscriptEvents': 'Gửi event transcript',
  'roleConfig.googleLiveSendLlmStateEvents': 'Gửi event trạng thái LLM',
  'roleConfig.googleLiveReconnectEnabled': 'Bật reconnect',
  'roleConfig.googleLiveReconnectMaxRetries': 'Số lần reconnect tối đa',
  'roleConfig.googleLiveReconnectBackoffMs': 'Độ trễ reconnect (ms)',
  'roleConfig.googleLiveFallback': 'Lỗi thì fallback về classic',
  ...
  'roleConfig.tooltip.voiceMode': 'Chọn giữa pipeline hiện tại và provider streaming Google Live',
  'roleConfig.tooltip.contextProvider': 'Khi TBOT được kích hoạt, lấy dữ liệu từ hệ thống bên ngoài và tiêm động vào lời nhắc hệ thống của LLM',
  ...
  'modelConfig.setDefaultSuccess': 'Đặt mô hình mặc định thành công, vui lòng khởi động lại module TBOT server thủ công kịp thời',
  ...
  'lesson.tvideoJourney.title': 'Biên soạn hành trình nông trại',
  'lesson.tvideoJourney.eyebrow': 'Renderer v4 · Hành trình nông trại',
  'lesson.tvideoJourney.locked': 'đã khóa',
  'lesson.tvideoJourney.buildIdentity': 'bản dựng {hash}',
  'lesson.tvideoJourney.previewModesLabel': 'Các chế độ xem trước TVideo Journey',
  'lesson.tvideoJourney.tab.sources': '3 nguồn',
  'lesson.tvideoJourney.tab.path': 'Đường đi hành trình',
  'lesson.tvideoJourney.tab.conversation': 'Hội thoại',
  'lesson.tvideoJourney.tab.flattened': 'Robot đã hợp nhất',
  'lesson.tvideoJourney.effectSummary': '{count} hiệu ứng đã khóa · {width}×{height} · {fps} FPS',
  'lesson.tvideoJourney.sourceIdentity.background': 'nền · phủ kín khung hình',
  'lesson.tvideoJourney.sourceIdentity.object': 'vật thể giảng dạy · PNG trong suốt',
  'lesson.tvideoJourney.sourceIdentity.robot': '{role} · hiển thị alpha/chroma WebM',
  'lesson.tvideoJourney.selectedWordLabel': 'Từ hành trình đã chọn',
  'lesson.tvideoJourney.selectedRobotRoleLabel': 'Vai trò robot đã chọn',
  'lesson.tvideoJourney.field.x': 'Vị trí ngang',
  'lesson.tvideoJourney.field.y': 'Vị trí dọc',
  'lesson.tvideoJourney.field.width': 'Chiều rộng an toàn',
  'lesson.tvideoJourney.field.height': 'Chiều cao an toàn',
  'lesson.tvideoJourney.field.stepKey': 'Khóa bước',
  'lesson.tvideoJourney.pronunciation.segments': 'Âm đoạn đã duyệt',
  'lesson.tvideoJourney.pronunciation.phonemes': 'Âm vị đã duyệt',
  'lesson.tvideoJourney.branch.target': 'Từ mục tiêu',
  'lesson.tvideoJourney.branch.meaning_vi': 'Nghĩa tiếng Việt',
  'lesson.tvideoJourney.branch.related': 'Khái niệm liên quan',
  'lesson.tvideoJourney.branch.silence': 'Im lặng',
  'lesson.tvideoJourney.branch.uncertain': 'Đóng góp chưa chắc chắn',
  'lesson.tvideoJourney.branch.retry_level_1': 'Hướng dẫn thử lại · mức 1',
  'lesson.tvideoJourney.branch.retry_level_2': 'Hướng dẫn thử lại · mức 2',
  'lesson.tvideoJourney.branch.retry_level_3': 'Hướng dẫn thử lại · mức 3',
  'lesson.tvideoJourney.safeZone': 'vùng an toàn',
  'lesson.tvideoJourney.orderedRouteLabel': 'Lộ trình hành trình có thứ tự',
  'lesson.tvideoJourney.scalePreserved': 'tỉ lệ {scale} (được giữ nguyên)',
  'lesson.tvideoJourney.timeOrdered': '{time} ms (theo thứ tự)',
  'lesson.tvideoJourney.pathVideoLoading': 'Đang tải video nền trực tiếp…',
  'lesson.tvideoJourney.pathVideoMissing': 'Chọn nền MP4 đã ghim để xem trước đường đi.',
  'lesson.tvideoJourney.pathVideoError': 'Không thể xem trước video nền đã chọn.',
  'lesson.tvideoJourney.pathPoint.flightStart': 'Điểm bắt đầu bay vào',
  'lesson.tvideoJourney.pathPoint.flightMid': 'Điểm giữa bay vào',
  'lesson.tvideoJourney.pathPoint.flightEnd': 'Điểm kết thúc bay vào',
  'lesson.tvideoJourney.pathPoint.landing': 'Hạ cánh',
  'lesson.tvideoJourney.pathPoint.walk': 'Điểm đi bộ {index}',
  'lesson.tvideoJourney.pathPoint.teachingAnchor': 'Neo giảng dạy',
  'lesson.tvideoJourney.pathPoint.objectAnchor': 'Neo vật thể',
  'lesson.tvideoJourney.pathPoint.safeZone': 'Gốc vùng an toàn',
  'lesson.tvideoJourney.contentEyebrow': 'Nội dung chính xác hai bước',
  'lesson.tvideoJourney.maxContextTurns': 'Số lượt ngữ cảnh tối đa: 2',
  'lesson.tvideoJourney.intro': 'Mở đầu',
  'lesson.tvideoJourney.explanation': 'Giải thích',
  'lesson.tvideoJourney.prompt': 'Lời nhắc',
  'lesson.tvideoJourney.derivativesEyebrow': 'Derivative từ backend',
  'lesson.tvideoJourney.cueSummary': '{count} cue · {state}',
  'lesson.tvideoJourney.publishReadyState': 'Backend sẵn sàng xuất bản: {ready}',
  'lesson.tvideoJourney.unavailable': 'không có',
  'lesson.tvideoJourney.simulatorEyebrow': 'Trình mô phỏng xác định',
  'lesson.tvideoJourney.childInputClassLabel': 'Nhóm đầu vào của trẻ',
  'lesson.tvideoJourney.cueEffectLabel': 'Mã cue / hiệu ứng',
  'lesson.tvideoJourney.previewAuthorityEyebrow': 'Xem trước · không phải thẩm quyền xuất bản',
  'lesson.tvideoJourney.previewCueLabel': 'Cue xem trước',
  'lesson.tvideoJourney.canvasLabel': 'Canvas xem trước TVideo Journey đã hợp nhất 480 x 320',
  'lesson.tvideoJourney.clockSummary': '{clock} ms · {fps} FPS',
  'lesson.tvideoJourney.canvasPreviewLabel': 'XEM TRƯỚC QUẢN TRỊ · KHÔNG PHẢI THẨM QUYỀN XUẤT BẢN',
  'lesson.tvideoJourney.simulation.bridge.targetNext': 'Hãy nối {target} với {nextTarget}.',
  'lesson.tvideoJourney.simulation.bridge.targetComplete': 'Con đã hoàn thành hành trình nông trại.',
  'lesson.tvideoJourney.simulation.bridge.meaning': '{meaning} liên hệ với từ tiếng Anh {target}.',
  'lesson.tvideoJourney.simulation.bridge.related': '{related} có liên quan đến {target}.',
  'lesson.tvideoJourney.simulation.bridge.silence': 'Cho trẻ thêm thời gian, sau đó đưa ra một gợi ý hình ảnh cụ thể.',
  'lesson.tvideoJourney.simulation.bridge.uncertain': 'Ghi nhận đóng góp rồi thu hẹp lời nhắc.',
  'lesson.tvideoJourney.simulation.bridge.retry': 'Duy trì sự tham gia của trẻ với mức hướng dẫn {level}.',
  'lesson.tvideoJourney.simulation.coaching.target': 'Ghi nhận đóng góp của trẻ.',
  'lesson.tvideoJourney.simulation.coaching.meaning': 'Mời trẻ nói từ {target}.',
  'lesson.tvideoJourney.simulation.coaching.related': 'Phát triển ý của trẻ rồi đọc mẫu {target}.',
  'lesson.tvideoJourney.simulation.coaching.silence': 'Chỉ vào vật thể giảng dạy và mời trẻ nói {target}.',
  'lesson.tvideoJourney.simulation.coaching.uncertain': 'Hỏi xem vật thể có phải là {target} rồi đọc mẫu nhẹ nhàng.',
  'lesson.tvideoJourney.simulation.coaching.retry1': 'Lặp lại {target} thật chậm.',
  'lesson.tvideoJourney.simulation.coaching.retry2': 'Tách các âm đã duyệt của {target}.',
  'lesson.tvideoJourney.simulation.coaching.retry3': 'Đọc mẫu {target}, dùng hướng dẫn tiếng Việt rồi mời trẻ thử thêm một lần.',
  'lesson.tvideoJourney.lockedPreset': 'Danh tính preset, hiệu ứng, thời lượng, easing và confetti được khóa theo bản dựng backend.',
  'lesson.tvideoJourney.loading': 'Đang tải preset hành trình đã khóa và trạng thái backend hiện tại…',
  'lesson.tvideoJourney.loadFailed': 'Không thể tải dữ liệu biên soạn TVideo Journey.',
  'lesson.tvideoJourney.saved': 'Đã lưu hành trình. Dữ liệu chuẩn hóa và trạng thái derivative từ backend đang được hiển thị.',
  'lesson.tvideoJourney.save': 'Lưu hành trình',
  'lesson.tvideoJourney.reload': 'Tải lại dữ liệu backend',
  'lesson.tvideoJourney.unsaved': 'Hành trình có thay đổi chưa lưu',
  'lesson.tvideoJourney.previewOnly': 'Chỉ là bản xem trước. Trạng thái sẵn sàng xuất bản chỉ đến từ derivative backend.',
  'lesson.tvideoJourney.noGoogleCall': 'Trình mô phỏng này hoàn toàn xác định và không gọi Google Live.',
  'lesson.tvideoJourney.selectBackground': 'Chọn một phiên bản asset MP4 480×320 đã ghim.',
  'lesson.tvideoJourney.background': 'Nguồn nền video trực tiếp',
  'lesson.tvideoJourney.teachingObject': 'Nguồn vật thể giảng dạy',
  'lesson.tvideoJourney.robotClip': 'Vai trò / clip robot',
  'lesson.tvideoJourney.pathHelp': 'Kéo bằng chuột hoặc cảm ứng, hoặc dùng tọa độ x/y chuẩn hóa. Thời gian và tỉ lệ keyframe giữ nguyên thứ tự.',
  'lesson.tvideoJourney.content': 'Nội dung từ vựng và hướng dẫn nông trại',
  'lesson.tvideoJourney.targetWord': 'Từ mục tiêu',
  'lesson.tvideoJourney.expectedAnswer': 'Câu trả lời mong đợi',
  'lesson.tvideoJourney.slowModel': 'Mẫu đọc chậm',
  'lesson.tvideoJourney.meaningsVi': 'Nghĩa tiếng Việt (mỗi dòng một mục)',
  'lesson.tvideoJourney.related': 'Khái niệm liên quan (mỗi dòng một mục)',
  'lesson.tvideoJourney.questionSeeds': 'Câu hỏi gợi ý (mỗi dòng một mục)',
  'lesson.tvideoJourney.pronunciationUnits': 'Âm đoạn hoặc âm vị',
  'lesson.tvideoJourney.units': 'Đơn vị phát âm đã duyệt',
  'lesson.tvideoJourney.l1Guidance': 'Hướng dẫn L1 tiếng Việt',
  'lesson.tvideoJourney.contextTurns': 'Lượt ngữ cảnh (tối đa 2)',
  'lesson.tvideoJourney.inputClass': 'Nhóm đầu vào của trẻ đã chọn',
  'lesson.tvideoJourney.nextIntent': 'Ý định tiếp theo',
  'lesson.tvideoJourney.question': 'Câu hỏi tiếp theo',
  'lesson.tvideoJourney.bridge': 'Câu nối',
  'lesson.tvideoJourney.coaching': 'Hướng dẫn',
  'lesson.tvideoJourney.coachingLevel': 'Mức hướng dẫn',
  'lesson.tvideoJourney.progressResult': 'Kết quả tiến độ',
  'lesson.tvideoJourney.play': 'Phát',
  'lesson.tvideoJourney.pause': 'Tạm dừng',
  'lesson.tvideoJourney.replay': 'Phát lại',
  'lesson.tvideoJourney.attempts': 'Số lần thử',
  'lesson.tvideoJourney.rebuildGuidance': 'Xử lý mã lỗi cue, lưu nếu nguồn đã đổi, rồi dùng thao tác dựng lại/thử lại trên máy chủ. Không thay thế danh tính derivative ở phía trình duyệt.',
  'lesson.tvideoJourney.status.not-requested': 'Chưa yêu cầu',
  'lesson.tvideoJourney.status.queued': 'Đang chờ',
  'lesson.tvideoJourney.status.processing': 'Đang xử lý',
  'lesson.tvideoJourney.status.retryable': 'Có thể thử lại',
  'lesson.tvideoJourney.status.ready': 'Sẵn sàng',
  'lesson.tvideoJourney.status.failed': 'Thất bại',
  'lesson.tvideoJourney.status.stale': 'Đã cũ',
