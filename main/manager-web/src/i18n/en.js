export default {
  ...
  'lesson.sdSyncTitle': 'Offline SD sync',
  'lesson.sdSyncTotal': 'Total',
  'lesson.sdSyncCounters': 'Lesson SD sync counters',
  'lesson.sdSyncComplete': 'Complete',
  'lesson.sdSyncSyncing': 'Syncing',
  'lesson.sdSyncOfflinePending': 'Offline pending',
  'lesson.sdSyncFailed': 'Failed',
  'lesson.sdSyncRemaining': 'Remaining',
  'lesson.sdSyncRetry': 'Retry',
  'lesson.sdSyncRetryQueued': 'SD sync retry queued.',
  'lesson.sdSyncRetryFailed': 'SD sync retry failed: {reason}',
  'lesson.sdSyncVersion': 'Version',
  'lesson.sdSyncChecksum': 'Checksum',
  'lesson.sdSyncLastSuccess': 'Last success',
  'lesson.sdSyncLastError': 'Last error',
  'lesson.sdSyncDevices': 'Devices',
  'lesson.sdSyncDevice': 'Device',
  'lesson.sdSyncState': 'State',
  'lesson.sdSyncError': 'Error',
  'lesson.sdSyncNoDevices': 'No assigned devices have confirmed this lesson for offline use.',
  'lesson.sdSyncOfflineAvailable': 'Available offline on every assigned device.',
  'lesson.sdSyncNotOfflineReady': 'Not yet available offline on every assigned device.',
  'lesson.sdSyncUnavailable': 'Unavailable',
  'lesson.sdSyncUnknown': 'Unknown',
