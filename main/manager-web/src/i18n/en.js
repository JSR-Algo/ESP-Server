export default {
  ...
  'course.colKey': 'Course key',
  'course.colTitle': 'Title',
  'course.colLocale': 'Locale',
  'course.colAgeBand': 'Age band',
  'course.colStatus': 'Status',
  'course.colQuality': 'Quality',
  'course.colActions': 'Actions',
  'course.edit': 'Edit',
  'course.delete': 'Delete',
  'course.save': 'Save',
  'course.cancel': 'Cancel',
  'course.empty': 'No courses yet',
  'course.keyPlaceholder': 'e.g. w02-numbers',
  'course.required': 'Please fill in all fields',
  'course.created': 'Course created',
  'course.updated': 'Course updated',
  'course.deleted': 'Course deleted',
  'course.deleteConfirm': 'Delete course "{key}"? This cannot be undone.',
  'course.loadFail': 'Failed to load courses',
  'course.lessons': 'Lessons',
  'course.colType': 'Type',
  'course.template': 'Template',
  'course.clonedTag': 'Custom',
  'course.clone': 'Clone',
  'course.markTemplate': 'Mark template',
  'course.unmarkTemplate': 'Unmark template',
  'course.markedTemplate': 'Marked as template',
  'course.unmarkedTemplate': 'Unmarked as template',
  'course.cloneTitle': 'Clone → customize',
  'course.cloneHint': 'Create an editable custom copy of "{source}" — lessons, steps and assets are deep-copied as a draft.',
  'course.cloned': 'Course cloned',
  'course.copyOf': 'Copy of {title}',
  'course.filterAll': 'All',
  'course.filterTemplate': 'Templates',
  'course.filterCustom': 'Custom',
  'course.statTotal': 'Total courses',
  'course.statTemplates': 'Templates',
  'course.statCustom': 'Custom courses',
  'course.statPublished': 'Published',
  'course.insights': 'Learner & quality',
  'course.quickSearchPlaceholder': 'Search courses by keyword, key, title or age band',
  'course.learnerFilterPlaceholder': 'Child name, interest or parent career',
  'course.openLearners': 'Filter by child/personality',
  'course.riskAll': 'All quality states',
  'course.qualityPreview': 'Avg quality',
  'course.needsAttention': 'Courses needing action',
  'course.quality': 'Analyze',
  'course.noQuality': 'No data',
  'course.qualityLoadFail': 'Course quality could not be loaded, so quality scores and the risk filter are unavailable. The course list itself is unaffected.',
  'course.qualityUnavailable': 'Unavailable',

  // Course insights: learner personality management + course quality monitoring
  'insights.pageTitle': 'Learner & Quality',
  'insights.backendHint': 'Backed by the NestJS course insights API (/v1/admin/course-insights)',
  'insights.tabLearners': 'Child personality',
  'insights.tabQuality': 'Course quality',
  'insights.backCourses': 'Courses',
  'insights.refresh': 'Refresh',
  'insights.search': 'Search',
  'insights.searchLearner': 'Search child, parent, career or interest',
  'insights.searchLessonKeyword': 'Filter lessons by keyword, title, course or tag',
  'insights.searchCourseKeyword': 'Filter courses by keyword or course key',
  'insights.child': 'Child / parent',
  'insights.personality': 'Personality signals',
  'insights.progress': 'Progress',
  'insights.noLearners': 'No learner profiles',
  'insights.selectLearner': 'Select a child profile',
  'insights.age': 'Age',
  ...
  'insights.previewLessons': 'Preview suitable lessons',
  'insights.rank': 'Rank',
  'insights.lesson': 'Lesson',
  'insights.match': 'Match',
  'insights.reason': 'Reason',
  'insights.difficultyFit': 'difficulty',
  'insights.durationFit': 'duration',
  'insights.noPreview': 'No suitable lessons',
  'insights.loadLearnersFail': 'Failed to load learner profiles',
  'insights.personalitySaved': 'Personality saved',
  'insights.saveFail': 'Failed to save personality',
  'insights.previewFail': 'Failed to preview lessons',
  'insights.qualityFail': 'Failed to load course quality',
  'insights.window7': 'Last 7 days',
  'insights.window14': 'Last 14 days',
  'insights.window30': 'Last 30 days',
  'insights.window90': 'Last 90 days',
  'insights.avgQuality': 'Avg quality',
  'insights.totalAssignments': 'Assignments',
  'insights.activeChildren': 'Active children',
  'insights.needsAttention': 'Needs attention',
  'insights.riskLevel': 'Status',
  'insights.riskAll': 'All statuses',
  'insights.riskAttention': 'Needs attention',
  'insights.riskWatch': 'Watch',
  'insights.riskHealthy': 'Healthy',
  'insights.qualityScore': 'Quality',
  'insights.scoreBreakdown': 'Score breakdown',
  'insights.completionShort': 'Done',
  'insights.successShort': 'OK',
  'insights.personalizationShort': 'Fit',
  'insights.coverage': 'Personalized lessons',
  'insights.completionRate': 'Completion',
  'insights.successRate': 'Step success',
  'insights.avgDuration': 'Duration',
  'insights.failed': 'Failed',
  'insights.running': 'Running',
  'insights.issues': 'Issues',
  'insights.noIssues': 'No issues',
  'insights.issue.no-activity': 'no activity',
  'insights.issue.low-completion': 'low completion',
  'insights.issue.low-success': 'low success',
  'insights.issue.low-personalization': 'low personalization',
  'insights.issue.has-failures': 'has failures',
  'insights.lastActivity': 'Last activity',
  'insights.noQuality': 'No course quality data',

  // Admin lesson-monitoring (NestJS API via /nestjs proxy)
  'monitoring.pageTitle': 'Lesson Monitoring',
  'monitoring.backendHint': 'Backed by the NestJS API (/v1/admin/lesson-monitoring) via proxy',
  'monitoring.refresh': 'Refresh',
  'monitoring.filterKeyword': 'Keyword: child, device, lesson or course',
  'monitoring.filterDeviceId': 'Filter by device ID',
  'monitoring.filterChildId': 'Filter by child ID',
  ...
  'monitoring.colSteps': 'Steps',
  'monitoring.colStartedAt': 'Started',
  'monitoring.colCompletedAt': 'Completed',
  'monitoring.colActions': 'Actions',
  ...
  'monitoring.evStep': 'Step',
  'monitoring.evOutcome': 'Outcome',
  'monitoring.evOccurredAt': 'Occurred',
  'monitoring.evEmpty': 'No events',
  'monitoring.close': 'Close',

  // Lesson / step / asset / publish (NestJS authoring API via /nestjs proxy)
  'lesson.pageTitle': 'Lessons',
  'lesson.createBtn': 'Create lesson',
  'lesson.createTitle': 'Create lesson',
  'lesson.colKey': 'Lesson key',
  'lesson.colTitle': 'Title',
  'lesson.colVersion': 'Version',
  'lesson.colStatus': 'Status',
  'lesson.colActions': 'Actions',
  'lesson.editSteps': 'Edit steps',
  'lesson.delete': 'Delete',
  'lesson.empty': 'No lessons yet',
  'lesson.keyPlaceholder': 'e.g. w02-d01-run-say-it',
  'lesson.created': 'Lesson created',
  'lesson.deleted': 'Lesson deleted',
  'lesson.deleteConfirm': 'Delete lesson "{key}"? This cannot be undone.',
  'lesson.newVersion': 'Edit as new version',
  'lesson.newVersionHint': 'Published lessons are immutable. This copies the lesson into a new draft you can edit; publishing it replaces the live version.',
  'lesson.newVersionConfirm': 'Create a new editable version of "{key}"? Publishing it will replace the live lesson.',
  'lesson.newVersionCreated': 'New draft v{v} created — edit and publish to replace the live version',
  'lesson.statTotal': 'Total lessons',
  'lesson.statMonitorable': 'Monitorable',
  'lesson.statPersonalized': 'Personality-ready',
  'lesson.statDuration': 'Planned duration',
  'lesson.filterKeyword': 'Search lesson or tag',
  'lesson.filterStatus': 'Status',
  'lesson.filterType': 'Type',
  'lesson.filterPersonality': 'Personality tag',
  'lesson.filterDifficulty': 'Difficulty',
  'lesson.filterMonitorable': 'Monitorable',
  'lesson.clearFilters': 'Clear filters',
  'lesson.colLessonType': 'Type',
  'lesson.colPersonalityTags': 'Personality tags',
  'lesson.colDifficulty': 'Difficulty',
  'lesson.colDuration': 'Duration',
  'lesson.colMonitorable': 'Monitor',
  'lesson.noTags': 'No tags',
  'lesson.monitorableYes': 'Yes',
  'lesson.monitorableNo': 'No',
  'lesson.editMetadata': 'Metadata',
  'lesson.editMetadataTitle': 'Edit lesson metadata',
  'lesson.metadataSaved': 'Lesson metadata saved',
  'lesson.topicTagsPlaceholder': 'animals, farm, visual',
  'lesson.durationHelp': 'seconds, used by attention-span ranking',
  'lesson.ageBandUnenforced': 'This age band has no starting age, so the age restriction will NOT be enforced — any child can be assigned this lesson. Use a band like 4-6.',
  'lesson.ageBandCustom': 'Custom band — the age restriction will block children under {min}.',
  'lesson.monitor': 'Monitor',
  'lesson.assignToChild': 'Assign to child',
  'lesson.assignDialogTitle': 'Assign lesson to child',
  'lesson.assignChildPlaceholder': 'Search child by name or parent email',
  'lesson.assignDevice': 'Device',
  'lesson.assignSerial': 'Serial',
  'lesson.assignAvailability': 'Availability',
  'lesson.assignCurrent': 'Current assignment',
  'lesson.assignNoCurrent': 'No active assignment',
  'lesson.assignNoDevices': 'No eligible active robots',
  'lesson.assignChooseChild': 'Choose a child to load robots',
  'lesson.assignAvailable': 'Available',
  'lesson.assignAlready': 'Already assigned',
  'lesson.assignBusy': 'Busy',
  'lesson.assignReuse': 'Reuse',
  'lesson.assign': 'Assign',
  'lesson.assignLearnersLoadFail': 'Failed to load children',
  'lesson.assignEligibilityLoadFail': 'Failed to load robot availability',
  'lesson.assignCreatedSuccess': 'Assignment created',
  'lesson.assignAlreadySuccess': 'Assignment already exists for this child and lesson',
  'lesson.assignConflict': 'Robot is busy. Availability was refreshed; open monitoring for details.',
  'lesson.assignFailed': 'Assignment failed',
  'lesson.assignUncertainRetry': 'Assignment result is uncertain. Availability was refreshed; retry is available.',
  'lesson.loadFail': 'Failed to load lessons',
  'lesson.steps': 'Steps',
  'lesson.stepType': 'Step type',
  'lesson.prompt': 'Prompt',
  'lesson.promptEditorLabel': 'Step prompt',
  'lesson.promptEditorHint': 'Edit the instruction shown and spoken for this step. Maximum 500 characters.',
  'lesson.stepSaved': 'Step saved to the lesson draft.',
  ...
  'lesson.visualTripleTitle': 'Lesson background, object, and robot video',
  ...
  'lesson.addStep': 'Add step',
  'lesson.deleteStep': 'Delete',
  'lesson.deleteStepConfirm': 'Delete step "{key}"?',
  'lesson.noSteps': 'No steps yet',
  'lesson.draftOnly': 'Steps can only be edited on draft lessons.',
  'lesson.stepRequired': 'Step type, prompt and subject are required',
  'lesson.assets': 'Asset upload',
  'lesson.pickImage': 'Pick image',
  'lesson.uploadAsset': 'Upload',
  'lesson.assetHint': 'A playable bundle needs a critical backgroundScene + teachingObject',
  'lesson.uploadOk': 'Asset uploaded (server-authoritative digest)',
  ...
  'lesson.validOk': 'Valid for: {profiles}',
  'lesson.validFail': 'Validation failed',
  'lesson.previewManifest': 'Preview',
  'lesson.checksum': 'checksum (server)',
  'lesson.publish': 'Publish',
  'lesson.publishConfirm': 'Publish this lesson? Published lessons are immutable.',
  'lesson.publishedMsg': 'Published v{v} · checksum {checksum}',
  'lesson.publishedOfflineSyncContinues': 'Published v{v} · checksum {checksum}. Offline SD sync continues asynchronously.',
  'lesson.sdSyncTitle': 'Lesson generation rollout',
  'lesson.sdSyncCounters': 'Lesson generation rollout totals',
  'lesson.sdSyncMetadata': 'Generation rollout metadata',
  'lesson.sdSyncGeneration': 'Generation',
  'lesson.sdSyncCurriculumLessons': 'Curriculum lessons',
  'lesson.sdSyncTotalPacks': 'Total packs',
  'lesson.sdSyncConnected': 'Connected',
  'lesson.sdSyncCurrent': 'Current',
  'lesson.sdSyncRetrying': 'Retrying',
  'lesson.sdSyncFailed': 'Failed',
  'lesson.sdSyncRetryAction': 'Retry rollout',
  'lesson.sdSyncRetryQueued': 'Lesson generation rebuild queued and the robot service retry started.',
  'lesson.sdSyncRetryQueuedDeferred': 'Lesson generation rebuild queued; the robot service will retry materialization shortly.',
  'lesson.sdSyncRetryQueuedUnavailable': 'Lesson generation rebuild queued; the robot service is currently unavailable and will pick it up when it recovers.',
  'lesson.sdSyncRetryNotQueued': 'The lesson generation rebuild could not be queued.',
  ...
  'lesson.sdSyncMaterializationState': 'Materialization',
  'lesson.sdSyncLastBuild': 'Last build update',
  'lesson.sdSyncLastPoll': 'Last poll',
  'lesson.sdSyncLastMaterialized': 'Last materialized',
  'lesson.sdSyncLastErrorCode': 'Last error code',
  'lesson.sdSyncUnavailable': 'Unavailable',
  'lesson.sdSyncStateAllCurrent': 'Connected robots current',
  'lesson.sdSyncStateAllCurrentDescription': 'Every currently connected robot reports the latest accepted generation.',
  'lesson.sdSyncStateNoConnected': 'No robots connected',
  'lesson.sdSyncStateNoConnectedDescription': 'No connected robot is available to confirm the current rollout.',
  'lesson.sdSyncStateBuilding': 'CMS build in progress',
  'lesson.sdSyncStateBuildingDescription': 'The CMS is preparing a newer lesson generation.',
  'lesson.sdSyncStateMaterializing': 'Materializing',
  'lesson.sdSyncStateMaterializingDescription': 'The robot service is preparing the accepted generation for delivery.',
  'lesson.sdSyncStateRetrying': 'Retrying',
  'lesson.sdSyncStateRetryingDescription': 'The service or one or more connected robots are retrying the rollout.',
  'lesson.sdSyncStateFailed': 'Attention required',
  'lesson.sdSyncStateFailedDescription': 'The CMS build or at least one connected robot reports a failure.',
  'lesson.sdSyncStateGenerationMismatch': 'Generation mismatch',
  'lesson.sdSyncStateGenerationMismatchDescription': 'The CMS generation and the robot service accepted generation do not match yet.',
  'lesson.sdSyncStateRollingOut': 'Rolling out',
  'lesson.sdSyncStateRollingOutDescription': 'Some currently connected robots have not received the accepted generation yet.',
  'lesson.sdSyncStatePolling': 'Waiting for materialization',
  'lesson.sdSyncStatePollingDescription': 'The robot service is polling for or validating the latest CMS generation.',
  'lesson.sdSyncBuildIdle': 'Idle',
  'lesson.sdSyncBuildPending': 'Pending',
  'lesson.sdSyncBuildBuilding': 'Building',
  'lesson.sdSyncBuildFailed': 'Failed',
  'lesson.sdSyncBuildWithPending': '{state} ({count} pending)',
  'lesson.sdSyncMaterializationEmpty': 'Waiting for first generation',
  'lesson.sdSyncMaterializationPolling': 'Polling',
  'lesson.sdSyncMaterializationMaterializing': 'Materializing',
  'lesson.sdSyncMaterializationRetryWait': 'Waiting to retry',
  'lesson.sdSyncMaterializationReady': 'Ready',
  'lesson.publishReadiness': 'Publish evidence',
  'lesson.flattenedDerivativeTitle': 'Robot Flattened media readiness',
  'lesson.flattenedDerivativeHint': 'Server-rendered renderer-v4 cinematic phases required for publish.',
  'lesson.flattenedDerivativeRefresh': 'Refresh status',
  'lesson.flattenedDerivativeLoading': 'Checking authoritative derivative status…',
  'lesson.flattenedDerivativeNotRequired': 'No renderer-v4 flattened phases are required for this lesson.',
  'lesson.flattenedDerivativeStatusFailed': 'Could not load derivative status: {reason}',
  'lesson.flattenedDerivativeServerFailed': 'Server render failed ({code}). Refresh after the source or worker issue is fixed.',
  'lesson.flattenedDerivativePreviewFailed': 'The derivative is ready on the server, but this browser could not preview it. Check media access or CORS; server readiness is unchanged.',
  'lesson.flattenedDerivativePublishConflict': 'Publish was blocked because current flattened media is no longer ready. Status has been refreshed; wait for every phase to become ready.',
  'lesson.flattenedDerivativeState.not-requested': 'Not requested',
  'lesson.flattenedDerivativeState.processing': 'Processing',
  'lesson.flattenedDerivativeState.ready': 'Ready',
  'lesson.flattenedDerivativeState.failed': 'Failed',
  'lesson.flattenedDerivativeState.stale': 'Stale',
  'lesson.serverValidation': 'Authoritative server validation',
  'lesson.validationMissing': 'NOT RUN',
  'lesson.proofStale': 'STALE',
  'lesson.validationProfiles': 'Profiles',
  'lesson.validationNoFindings': 'The server reported no errors or warnings.',
  'lesson.validationRunHint': 'Run validation after saving every change. Results remain visible here.',
  'lesson.budgetDownload': 'Download',
  'lesson.budgetAssets': 'Unique / shared',
  'lesson.budgetPsram': 'Peak PSRAM',
  'lesson.budgetOffline': 'Offline',
  'lesson.budgetPaths': 'All paths',
  'lesson.publishReviewTitle': 'Immutable version review',
  'lesson.publishImmutableWarning': 'Publishing creates the reviewed version. The previous published version must remain byte-for-byte and pin-for-pin unchanged.',
  'lesson.publishFirstWarning': 'Publishing transitions this reviewed v1 draft in place. Its manifest bytes and all-profile asset pins must match the reviewed evidence.',
  'lesson.publishSourceEvidence': 'Original published version',
  'lesson.publishFirstSourceEvidence': 'Reviewed first-version draft bytes',
  'lesson.publishTargetEvidence': 'Reviewed target version',
  'lesson.publishSimulationEvidence': 'Simulation completion',
  'lesson.publishSourcePins': 'Exact original asset pins and bytes',
  'lesson.publishFirstPins': 'Exact reviewed v1 draft asset pins and bytes',
  'lesson.statusPass': 'PASS',
  'lesson.statusFail': 'FAIL',
  'lesson.statusReady': 'READY',
  'lesson.statusCheck': 'CHECK',
  'lesson.publishFieldLesson': 'Lesson',
  'lesson.publishFieldVersion': 'Version',
  'lesson.publishFieldChecksum': 'Checksum',
  'lesson.publishFieldPins': 'Pins',
  'lesson.publishFieldBytes': 'Bytes',
  'lesson.publishFieldSteps': 'Steps',
  'lesson.publishFieldAssets': 'Assets',
  'lesson.publishFieldProfile': 'Profile',
  'lesson.publishFieldStage': 'Stage',
  'lesson.publishFieldEtag': 'ETag',
  'lesson.publishFieldProof': 'proof',
  'lesson.publishOriginalPass': 'Original immutability: PASS',
  'lesson.publishOriginalFail': 'Original immutability: FAIL',
  'lesson.publishFirstSourcePass': 'Reviewed v1 draft bytes preserved: PASS',
  'lesson.publishFirstSourceFail': 'Reviewed v1 draft bytes preserved: FAIL',
  'lesson.publishTargetPass': 'Published target identity: PASS',
  'lesson.publishTargetFail': 'Published target identity: FAIL',
  'lesson.publishTargetSummary': 'v{version} · {checksum} · {count} assets',
  'lesson.publishChecksumUnavailable': 'checksum unavailable',
  'lesson.publishCompletionUnavailable': 'completion event unavailable',
  'lesson.publishEvidenceIdentityMissing': 'Lesson evidence identity is missing.',
  'lesson.publishManifestEvidenceMalformed': 'Authoritative manifest evidence was malformed.',
  'lesson.publishAssetEvidenceMalformed': 'Authoritative all-profile asset evidence was malformed.',
  'lesson.publishTargetIdentityMalformed': 'The published target identity response was malformed.',
  'lesson.publishFailed': 'Publish failed: {reason}',
  'lesson.publishResponseMalformed': 'The publish response was malformed; authoritative reconciliation is required.',
  'lesson.publishReconciling': 'Reconciling the authoritative publish state…',
  ...
  'lesson.publishDiffOriginalChecksum': 'Original checksum changed: {before} → {after}.',
  'lesson.publishDiffOriginalRowChecksum': 'Original lesson-row checksum changed or no longer matches its authoritative manifest.',
  'lesson.publishDiffOriginalManifest': 'Original manifest bytes changed.',
  'lesson.publishDiffOriginalAssets': 'Original asset profiles, pins, digests, paths, metadata, or byte counts changed.',
  'lesson.publishDiffOriginalBytes': 'Original asset bytes changed: {before} → {after}.',
  'lesson.publishDiffOriginalUnavailable': 'Original verification is unavailable: {reason}',
  'lesson.publishDiffTargetMissing': 'Published target evidence is missing.',
  'lesson.publishDiffTargetIdentity': 'Published target lesson identity does not match the reviewed draft.',
  'lesson.publishDiffTargetStatus': 'The authoritative target lesson is not published.',
  'lesson.publishDiffTargetVersion': 'Published target version does not match the reviewed or publish-response version.',
  'lesson.publishDiffTargetRowChecksumMissing': 'Published target row checksum is missing.',
  'lesson.publishDiffTargetChecksum': 'Published target, publish-response, and reviewed preview checksums do not match.',
  'lesson.publishDiffTargetUnavailable': 'Published target verification is unavailable: {reason}',
  'lesson.publishImmutableAck': 'I reviewed v{target} and understand that source v{source} is immutable.',
  'lesson.publishFirstAck': 'I reviewed the first publication of v{target} and its exact draft bytes.',
  'lesson.publishReviewedVersion': 'Publish reviewed version',
  'lesson.publishOriginalMissing': 'The authoritative draft/source lesson rows could not be identified. Publishing is blocked.',
  'lesson.publishUncertain': 'Publish outcome is uncertain. Do not retry until authoritative lesson state is refreshed.',
  'lesson.publishVerified': 'Published and independently verified the original version unchanged.',
  'lesson.publishVerificationFailed': 'Published, but original immutability verification failed or is incomplete.',
  'lesson.publishFirstVerified': 'Published v1 and independently verified the reviewed draft bytes unchanged.',
  'lesson.publishFirstVerificationFailed': 'Published v1, but reviewed draft-byte verification failed or is incomplete.',
  // Step editor dialog (vocab + per-step rich fields)
  'lesson.addStepTitle': 'Add step',
  'lesson.stepTypePassive': 'Passive (auto-advance)',
  'lesson.stepTypeInteractive': 'Interactive (awaits child)',
  'lesson.subjectLabel': 'Vocab word / subject',
  'lesson.helperText': 'Helper text (on-screen hint)',
  'lesson.l1TransferHint': 'L1 transfer hint',
  'lesson.choices': 'Answer choices',
  'lesson.choiceLabel': 'Choice',
  'lesson.choiceCorrect': 'Correct',
  'lesson.addChoice': 'Add choice',
  'lesson.removeChoice': 'Remove',
  'lesson.blankHint': 'For fill-in-the-blank, write the blank as ___ in the prompt.',
  'lesson.fillBlankNeedsChoices': 'fillBlank needs at least 2 choices with exactly one marked correct.',
  'lesson.choiceLabelRequired': 'Every choice needs a label.',
  'lesson.cancel': 'Cancel',
  'lesson.save': 'Save',
  'lesson.colChoices': 'Choices',
  // Asset manager
  'lesson.layer': 'Layer',
  'lesson.role': 'Role',
  'lesson.assetKey': 'Asset key',
  'lesson.critical': 'Critical',
  'lesson.pose': 'Robot pose',
  'lesson.poseTeach': 'teach',
  'lesson.poseListening': 'listening',
  'lesson.poseThinking': 'thinking',
  'lesson.poseCelebrate': 'celebrate',
  'lesson.layerBackground': 'Background scene',
  'lesson.layerTeachingObject': 'Teaching object',
  'lesson.layerRobotOverlay': 'Robot overlay',
  'lesson.assetList': 'Uploaded this session',
  'lesson.assetPreview': 'Preview',
  'lesson.assetSessionOnly': 'List is session-only (no server asset listing yet).',
  'lesson.assetKeyRequired': 'Asset key is required.',
  'lesson.uploadReject415': 'Only PNG/JPEG are accepted for espTft.',
  // Asset management (server-backed list / delete / replace)
  'lesson.refresh': 'Refresh',
  'lesson.assetListEmpty': 'No assets uploaded yet.',
  'lesson.noPreview': 'No preview',
  'lesson.replaceAsset': 'Replace',
  'lesson.assetDeleteConfirm': 'Delete this asset from the bundle?',
  'lesson.assetDeleted': 'Asset deleted',
  'lesson.assetDeleteInUse': 'Cannot delete {assetKey}: still used by step(s) {steps}. Unbind it there first.',
  'lesson.stepSaveConflictChanged': 'Step {key} changed on the server while you were editing. Your draft was kept and the editor reloaded — review it, then save again to overwrite.',
  'lesson.stepSaveConflictRemoved': 'Step {key} no longer exists on the server. Your draft was kept but cannot be saved to this step.',
  'lesson.stepSaveConflictCheckFailed': 'Could not confirm the step is unchanged before saving ({reason}). Nothing was written.',
  'lesson.unsavedLeaveTitle': 'Unsaved changes',
  'lesson.unsavedLeaveBody': 'This lesson has unsaved step changes. Leaving now discards them.',
  'lesson.unsavedLeaveDiscard': 'Discard and leave',
  'lesson.unsavedLeaveStay': 'Stay',
  'lesson.sharedVisual': 'Shared visual',
  'lesson.sharedVisualFilter': 'Filter asset key',
  'lesson.sharedVisualEmpty': 'No matching shared visuals.',
  'lesson.sharedImpactTitle': 'Review shared visual impact',
  'lesson.sharedImpactSourceKey': 'Source asset key',
  'lesson.sharedImpactChecksum': 'Source checksum',
  'lesson.sharedImpactCloneKey': 'Draft clone key',
  'lesson.sharedImpactUsages': 'Backend usages',
  'lesson.sharedImpactLessonKey': 'Lesson key',
  'lesson.sharedImpactLesson': 'Lesson',
  'lesson.sharedImpactVersion': 'Version',
  'lesson.sharedImpactStatus': 'Status',
  'lesson.sharedImpactProfile': 'Profile',
  'lesson.sharedImpactUsageKey': 'Pinned key',
  'lesson.sharedImpactNoUsages': 'The backend reported no other usages.',
  'lesson.sharedImpactLocalSteps': 'Affected steps in this draft',
  'lesson.sharedImpactNoLocalSteps': 'No current draft step references this key.',
  ...
  'lesson.renderExpressionHint': 'Only the robot face changes on-device. Listening and Thinking show the same face; background/object/pose are authored but not rendered by current firmware.',
  // Structured vocabulary (stored under stepBody.vocab; author metadata only)
  'lesson.vocabSection': 'Vocabulary',
  'lesson.vocabWord': 'Word',
  'lesson.vocabIpa': 'IPA / phonetics',
  'lesson.vocabPos': 'Part of speech',
  'lesson.vocabTranslation': 'Translation (vi)',
  'lesson.vocabDefinition': 'Definition',
  'lesson.vocabExamples': 'Examples',
  'lesson.vocabExampleText': 'Example sentence',
  'lesson.vocabExampleTranslation': 'Translation (optional)',
  'lesson.addExample': 'Add example',
  'lesson.removeExample': 'Remove',
  'lesson.pos_noun': 'noun',
  'lesson.pos_verb': 'verb',
  'lesson.pos_adjective': 'adjective',
  'lesson.pos_adverb': 'adverb',
  'lesson.pos_pronoun': 'pronoun',
  'lesson.pos_preposition': 'preposition',
  'lesson.pos_conjunction': 'conjunction',
  'lesson.pos_interjection': 'interjection',
  'lesson.pos_determiner': 'determiner',
  // Per-step Scene composer
  'lesson.sceneSection': 'Scene',
  'lesson.sceneNone': 'None',
  'lesson.sceneNoAssets': 'Upload background/teaching-object assets below to compose a scene.',
  'lesson.backgroundScene': 'Background scene',
  'lesson.altCaption': 'Alt caption',
  'lesson.fit': 'Fit',
  'lesson.teachingObject': 'Teaching object',
  'lesson.primaryWord': 'Primary word',
  'lesson.supportWords': 'Support words',
  'lesson.placement': 'Placement',
  'lesson.focusTarget': 'Focus target (tap window) — model step only',
  'lesson.addWindow': 'Add window',
  'lesson.successUtterance': 'Success utterance',
  'lesson.missUtterance': 'Miss utterance',
  'lesson.focusHint': 'x/y/w/h are clamped to 0–1 and each window must have tStart < tEnd (otherwise publish fails).',
  'lesson.timeoutSec': 'Timeout (sec)',

  // Per-user NestJS author login
  'nestLogin.title': 'Sign in as author (NestJS)',
  'nestLogin.hint': 'Authoring actions are attributed to this admin. Without it, a shared dev token is used.',
  'nestLogin.email': 'Email',
  'nestLogin.password': 'Password',
  'nestLogin.signIn': 'Author sign-in',
  'nestLogin.signedIn': 'Author signed in',
  'nestLogin.required': 'Email and password are required',
  'nestLogin.mfaHint': 'Enter the 6-digit code from your authenticator app.',
  'nestLogin.code': '6-digit code',
  'nestLogin.codeRequired': 'Enter the 6-digit code',
  'nestLogin.verify': 'Verify',
  'nestLogin.ok': 'Signed in as {role}',
  ...
  'device.searchPlaceholder': 'Search model, Mac address or child name',
  'device.childNamePlaceholder': 'Pick child name for device',
  'device.useChildName': 'Use child name',
  'device.applyChildProfile': 'Apply child profile',
  'device.selectChildNameFirst': 'Select a child name first',
  'device.childNameApplied': 'Device name updated to child name',
  'device.childProfileApplied': 'Device updated with child profile',
  'device.childProfile': 'Child profile',
  'device.childName': 'Child name',
  'device.childAge': 'Age',
  'device.childInterests': 'Interests, comma-separated',
  'device.learningStyle': 'Learning style',
  'device.vocabularyLevel': 'Vocabulary level',
  'device.parentCareer': 'Parent career topic',
  'device.yearsOld': 'years old',
  'device.childNameTooLong': 'Child name must be 64 characters or fewer',
  'device.childAgeInvalid': 'Child age must be from 1 to 18',
  'device.childProfileSaved': 'Device child profile saved',
  'device.childProfileSaveFailed': 'Could not save device child profile',
  ...
  'lesson.tvideoJourney.title': 'Farm Journey authoring',
  'lesson.tvideoJourney.eyebrow': 'Renderer v4 · Farm Journey',
  'lesson.tvideoJourney.locked': 'locked',
  'lesson.tvideoJourney.buildIdentity': 'build {hash}',
  'lesson.tvideoJourney.previewModesLabel': 'TVideo Journey preview modes',
  'lesson.tvideoJourney.tab.sources': '3 Sources',
  'lesson.tvideoJourney.tab.path': 'Journey Path',
  'lesson.tvideoJourney.tab.conversation': 'Conversation',
  'lesson.tvideoJourney.tab.flattened': 'Robot Flattened',
  'lesson.tvideoJourney.effectSummary': '{count} locked effects · {width}×{height} · {fps} FPS',
  'lesson.tvideoJourney.sourceIdentity.background': 'background · object-fit cover',
  'lesson.tvideoJourney.sourceIdentity.object': 'teaching object · alpha PNG',
  'lesson.tvideoJourney.sourceIdentity.robot': '{role} · WebM alpha/chroma visualization',
  'lesson.tvideoJourney.selectedWordLabel': 'Selected journey word',
  'lesson.tvideoJourney.selectedRobotRoleLabel': 'Selected robot role',
  'lesson.tvideoJourney.field.x': 'Horizontal position',
  'lesson.tvideoJourney.field.y': 'Vertical position',
  'lesson.tvideoJourney.field.width': 'Safe width',
  'lesson.tvideoJourney.field.height': 'Safe height',
  'lesson.tvideoJourney.field.stepKey': 'Step key',
  'lesson.tvideoJourney.pronunciation.segments': 'Approved segments',
  'lesson.tvideoJourney.pronunciation.phonemes': 'Approved phonemes',
  'lesson.tvideoJourney.branch.target': 'Target word',
  'lesson.tvideoJourney.branch.meaning_vi': 'Vietnamese meaning',
  'lesson.tvideoJourney.branch.related': 'Related concept',
  'lesson.tvideoJourney.branch.silence': 'Silence',
  'lesson.tvideoJourney.branch.uncertain': 'Uncertain contribution',
  'lesson.tvideoJourney.branch.retry_level_1': 'Retry coaching · level 1',
  'lesson.tvideoJourney.branch.retry_level_2': 'Retry coaching · level 2',
  'lesson.tvideoJourney.branch.retry_level_3': 'Retry coaching · level 3',
  'lesson.tvideoJourney.safeZone': 'safe zone',
  'lesson.tvideoJourney.orderedRouteLabel': 'Ordered journey route',
  'lesson.tvideoJourney.scalePreserved': 'scale {scale} (preserved)',
  'lesson.tvideoJourney.timeOrdered': '{time} ms (ordered)',
  'lesson.tvideoJourney.pathVideoLoading': 'Loading the live background video…',
  'lesson.tvideoJourney.pathVideoMissing': 'Select a pinned MP4 background to preview the path.',
  'lesson.tvideoJourney.pathVideoError': 'The selected background video could not be previewed.',
  'lesson.tvideoJourney.pathPoint.flightStart': 'Flight ingress start',
  'lesson.tvideoJourney.pathPoint.flightMid': 'Flight ingress midpoint',
  'lesson.tvideoJourney.pathPoint.flightEnd': 'Flight ingress end',
  'lesson.tvideoJourney.pathPoint.landing': 'Landing',
  'lesson.tvideoJourney.pathPoint.walk': 'Walk point {index}',
  'lesson.tvideoJourney.pathPoint.teachingAnchor': 'Teaching anchor',
  'lesson.tvideoJourney.pathPoint.objectAnchor': 'Object anchor',
  'lesson.tvideoJourney.pathPoint.safeZone': 'Safe zone origin',
  'lesson.tvideoJourney.contentEyebrow': 'Exact two-step content',
  'lesson.tvideoJourney.maxContextTurns': 'Maximum context turns: 2',
  'lesson.tvideoJourney.intro': 'Intro',
  'lesson.tvideoJourney.explanation': 'Explanation',
  'lesson.tvideoJourney.prompt': 'Prompt',
  'lesson.tvideoJourney.derivativesEyebrow': 'Backend derivatives',
  'lesson.tvideoJourney.cueSummary': '{count} cues · {state}',
  'lesson.tvideoJourney.publishReadyState': 'Backend publish ready: {ready}',
  'lesson.tvideoJourney.unavailable': 'unavailable',
  'lesson.tvideoJourney.simulatorEyebrow': 'Deterministic simulator',
  'lesson.tvideoJourney.childInputClassLabel': 'Child input class',
  'lesson.tvideoJourney.cueEffectLabel': 'Cue ID / effect',
  'lesson.tvideoJourney.previewAuthorityEyebrow': 'Preview · not publish authority',
  'lesson.tvideoJourney.previewCueLabel': 'Preview cue',
  'lesson.tvideoJourney.canvasLabel': 'TVideo Journey flattened 480 by 320 preview canvas',
  'lesson.tvideoJourney.clockSummary': '{clock} ms · {fps} FPS',
  'lesson.tvideoJourney.canvasPreviewLabel': 'ADMIN PREVIEW · NOT PUBLISH AUTHORITY',
  'lesson.tvideoJourney.simulation.bridge.targetNext': 'Let’s connect {target} to {nextTarget}.',
  'lesson.tvideoJourney.simulation.bridge.targetComplete': 'You completed the farm journey.',
  'lesson.tvideoJourney.simulation.bridge.meaning': '{meaning} connects to the English word {target}.',
  'lesson.tvideoJourney.simulation.bridge.related': '{related} is connected to {target}.',
  'lesson.tvideoJourney.simulation.bridge.silence': 'Give the child space, then offer one concrete visual cue.',
  'lesson.tvideoJourney.simulation.bridge.uncertain': 'Acknowledge the contribution and narrow the prompt.',
  'lesson.tvideoJourney.simulation.bridge.retry': 'Keep the child engaged with coaching level {level}.',
  'lesson.tvideoJourney.simulation.coaching.target': 'Confirm the child’s contribution.',
  'lesson.tvideoJourney.simulation.coaching.meaning': 'Invite the child to say {target}.',
  'lesson.tvideoJourney.simulation.coaching.related': 'Build on the child’s idea, then model {target}.',
  'lesson.tvideoJourney.simulation.coaching.silence': 'Point to the teaching object and invite {target}.',
  'lesson.tvideoJourney.simulation.coaching.uncertain': 'Ask whether the object is {target}, then model it gently.',
  'lesson.tvideoJourney.simulation.coaching.retry1': 'Repeat {target} slowly.',
  'lesson.tvideoJourney.simulation.coaching.retry2': 'Segment the approved sounds for {target}.',
  'lesson.tvideoJourney.simulation.coaching.retry3': 'Model {target}, use the Vietnamese guidance, and invite one more try.',
  'lesson.tvideoJourney.lockedPreset': 'Preset identity, effects, timing, easing, and confetti stay locked to the backend build.',
  'lesson.tvideoJourney.loading': 'Loading the locked journey preset and current backend status…',
  'lesson.tvideoJourney.loadFailed': 'The TVideo Journey authoring data could not be loaded.',
  'lesson.tvideoJourney.saved': 'Journey saved. Backend-normalized data and derivative statuses are shown.',
  'lesson.tvideoJourney.save': 'Save journey',
  'lesson.tvideoJourney.reload': 'Reload backend data',
  'lesson.tvideoJourney.unsaved': 'Unsaved journey changes',
  'lesson.tvideoJourney.previewOnly': 'Preview only. Publish readiness comes only from backend derivatives.',
  'lesson.tvideoJourney.noGoogleCall': 'This simulator is deterministic and never calls Google Live.',
  'lesson.tvideoJourney.selectBackground': 'Select a pinned 480×320 MP4 asset version.',
  'lesson.tvideoJourney.background': 'Live background source',
  'lesson.tvideoJourney.teachingObject': 'Teaching object source',
  'lesson.tvideoJourney.robotClip': 'Robot role / clip source',
  'lesson.tvideoJourney.pathHelp': 'Drag with mouse or touch, or use the normalized x/y controls. Keyframe times and scales remain ordered and unchanged.',
  'lesson.tvideoJourney.content': 'Farm vocabulary and coaching content',
  'lesson.tvideoJourney.targetWord': 'Target word',
  'lesson.tvideoJourney.expectedAnswer': 'Expected answer',
  'lesson.tvideoJourney.slowModel': 'Slow model',
  'lesson.tvideoJourney.meaningsVi': 'Vietnamese meanings (one per line)',
  'lesson.tvideoJourney.related': 'Related concepts (one per line)',
  'lesson.tvideoJourney.questionSeeds': 'Question seeds (one per line)',
  'lesson.tvideoJourney.pronunciationUnits': 'Segments or phonemes',
  'lesson.tvideoJourney.units': 'Approved units',
  'lesson.tvideoJourney.l1Guidance': 'Vietnamese L1 guidance',
  'lesson.tvideoJourney.contextTurns': 'Context turns (maximum 2)',
  'lesson.tvideoJourney.inputClass': 'Selected child input class',
  'lesson.tvideoJourney.nextIntent': 'Next intent',
  'lesson.tvideoJourney.question': 'Next question',
  'lesson.tvideoJourney.bridge': 'Bridge',
  'lesson.tvideoJourney.coaching': 'Coaching',
  'lesson.tvideoJourney.coachingLevel': 'Coaching level',
  'lesson.tvideoJourney.progressResult': 'Progress result',
  'lesson.tvideoJourney.play': 'Play',
  'lesson.tvideoJourney.pause': 'Pause',
  'lesson.tvideoJourney.replay': 'Replay',
  'lesson.tvideoJourney.attempts': 'Attempts',
  'lesson.tvideoJourney.rebuildGuidance': 'Resolve the typed cue issue, save if source data changed, then use the server rebuild/retry action. Do not replace derivative identity locally.',
  'lesson.tvideoJourney.status.not-requested': 'Not requested',
  'lesson.tvideoJourney.status.queued': 'Queued',
  'lesson.tvideoJourney.status.processing': 'Processing',
  'lesson.tvideoJourney.status.retryable': 'Retryable',
  'lesson.tvideoJourney.status.ready': 'Ready',
  'lesson.tvideoJourney.status.failed': 'Failed',
  'lesson.tvideoJourney.status.stale': 'Stale',
