...
export default {
  ...
  watch: {
    'form.sourceVersionId'(value, previous) { if (previous && value !== previous) { this.clearReviewIfClosed(); this.form.lessonIds = []; if (this.form.mode !== 'cloneForLesson' && this.form.targetVersionId === value) this.form.targetVersionId = (this.versions.find((v) => v.versionId !== value) || {}).versionId || ''; this.load(value); } },
    'form.targetVersionId'() { this.clearReviewIfClosed(); },
    'form.mode'(mode) { this.clearReviewIfClosed(); this.form.lessonIds = mode === 'cloneForLesson' ? '' : []; if (mode === 'cloneForLesson' && !this.form.targetVersionId) this.form.targetVersionId = this.form.sourceVersionId; if (mode !== 'cloneForLesson' && this.form.targetVersionId === this.form.sourceVersionId) this.form.targetVersionId = (this.versions.find((v) => v.versionId !== this.form.sourceVersionId) || {}).versionId || ''; },
