...
export default {
  ...
  data: () => ({ loading: false, submitting: false, assetDetail: {}, versions: [], usages: [], modes: REPLACEMENT_MODES, impactVisible: false, impact: {}, form: { sourceVersionId: '', targetVersionId: '', mode: 'global', lessonIds: [] } }),
  computed: {
    ...
    replacementReady() { const ids = Array.isArray(this.form.lessonIds) ? this.form.lessonIds : [this.form.lessonIds]; return Boolean(this.form.sourceVersionId && this.form.targetVersionId && replacementSelectionIsValid(this.usages, this.form.mode, ids)); },
