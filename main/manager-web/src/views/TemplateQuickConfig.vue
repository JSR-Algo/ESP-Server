      ...
      <div class="content-panel">
        <div class="content-area">
          <el-card class="config-card" shadow="never">
              ...
              <!-- Use same colored icon effect as role config page -->
...
export default {
  ...
  methods: {
    ...
    prepareConfigData() {
      return {
        ...
        sort: this.form.sort,
        functions: [],
        // Include necessary model fields to ensureAPICall succeeded
        ...this.form.model
      };
    },
    ...
    // Get template list and setSortnumber
  ...
  mounted() {
    ...
    if (templateId) {
      ...
      // New mode: set default value and getSortnumber
