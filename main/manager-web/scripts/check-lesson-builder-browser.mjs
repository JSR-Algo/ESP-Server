...
try {
  ...
  const result = await evaluate(`(async()=>{
    ...
    const testInput=(id)=>{const root=document.querySelector('[data-testid="'+id+'"]');return root&&root.matches('input,textarea')?root:root?.querySelector('input,textarea')};
