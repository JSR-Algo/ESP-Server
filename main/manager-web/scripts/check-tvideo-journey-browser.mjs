...
try {
  ...
  const result = await evaluate(`(async()=>{
    ...
    return{legacy,localized,unconfigured,hardcodedVisible,tabStates,rawTabKeys,pinnedAssets,keyboard,picker,path,branch,robotState,saveSuccess,saveError,dirtyProof,savingProof,restoredProof,gate:[gateFalse,gateTrue],routeReset,routeReload,runtimeText:document.body.innerText.slice(0,200)};
  })()`);
