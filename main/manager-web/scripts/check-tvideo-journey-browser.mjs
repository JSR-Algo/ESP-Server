...
try {
  ...
  const result = await evaluate(`(async()=>{
    ...
    return{legacy,localized,unconfigured,hardcodedVisible,tabStates,rawTabKeys,pinnedAssets,keyboard,picker,path,branch,robotState,robotJourneyStates,cueBinding,saveSuccess,saveError,dirtyProof,savingProof,restoredProof,gate:[gateFalse,gateTrue],routeReset,legacyV4,routeReload,runtimeText:document.body.innerText.slice(0,200)};
  })()`);
