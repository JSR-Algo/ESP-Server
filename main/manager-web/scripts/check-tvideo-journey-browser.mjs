...
try {
  ...
  const result = await evaluate(`(async()=>{
    ...
    return{legacy,localized,unconfigured,hardcodedVisible,tabStates,keyboard,picker,path,branch,robotState,saveSuccess,saveError,gate:[gateFalse,gateTrue],runtimeText:document.body.innerText.slice(0,200)};
  })()`);
