...
const calls = { update: [], visualFilters: [], validate: 0, preview: 0 };
const steps = [
...
const sharedAssets = [{ assetKey: 'object.barn', category: 'teachingObject', versionId: 'av-2', version: 2, storagePath: 'sd://shared/barn.png', sha256: 'abc123', bytes: 60000, width: 160, height: 120, usageCount: 4 }];
const validation = { valid: true, profiles: ['espTft'], budgets: { espTft: { errors: [], warnings: [], metrics: { assetCount: 7, packBytes: 222000, estimatedVisualPeakBytes: 640000, offlineReady: true, allPathsTerminate: true } } } };
...
LessonEditor.components.RobotLessonPreview = {
  name: 'RobotLessonPreview', props: ['manifest', 'stepIndex', 'initialPath'],
  render(h) { return h('div', { attrs: { 'data-preview-step': this.stepIndex, 'data-preview-profile': this.manifest.profile } }); },
};
