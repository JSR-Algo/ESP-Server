...
export default {
  ...
  'device.editProfile': 'Bearbeiten',
  'device.editProfileTitle': 'Geräte- und Kinderprofil',
  'device.deviceName': 'Gerätename',
  'device.deviceNamePlaceholder': 'Beispiel: Roboter im Kinderzimmer',
  'device.childProfile': 'Kinderprofil',
  'device.childName': 'Name des Kindes',
  'device.childNamePlaceholder': 'Name des Kindes eingeben',
  'device.childAge': 'Alter des Kindes',
  'device.childAgePlaceholder': '1-18',
  'device.childAgeInvalid': 'Alter muss eine Zahl von 1 bis 18 sein',
  'device.childSummaryWithAge': '{name}, {age} Jahre',
  'device.childNotSet': 'Name des Kindes nicht festgelegt',
  'device.saveProfile': 'Profil speichern',
  'device.profileSaveSuccess': 'Profil gespeichert',
  'device.profileSaveFailed': 'Profil konnte nicht gespeichert werden',
  ...
  'settings.validServerUrl': 'Bitte gültige Serveradresse eingeben (beginnt mit http oder https und endet mit /tbot)',
  ...
  // Über uns
  'settings.aboutApp': 'Über TBot Konsole',
  'settings.aboutContent': 'TBot Konsole\n\nEine plattformübergreifende mobile Management-App, erstellt mit Vue.js 3 + uni-app, bietet Geräteverwaltung, Agentenkonfiguration und andere Funktionen für tbot ESP32 Smart Hardware.\n\n© 2025 tbot-esp32-server {version}',
  ...
  'deviceConfig.connectToTbotHotspot': 'Bitte verbinden Sie sich zuerst mit dem tbot Hotspot',
  'deviceConfig.detecting': 'Erkennen...',
  'deviceConfig.reDetect': 'Erneut erkennen',
  'deviceConfig.alreadyConnected': 'Mit tbot Hotspot verbunden',
  ...
  'deviceConfig.bringPhoneCloseToTbotDevice': 'Bringen Sie das Telefon in die Nähe des tbot Geräts (1-2 Meter Entfernung)',
  'deviceConfig.duringAudioPlaybackTbotWillReceive': 'Während der Audio-Wiedergabe empfängt tbot und dekodiert Konfigurationsinformationen',
  ...
  'deviceConfig.connectTbotHotspot': 'Bitte verbinden Sie sich mit dem tbot Hotspot',
  ...
  'deviceConfig.connectedTbotHotspot': 'Mit tbot Hotspot verbunden',
  ...
  'deviceConfig.pleaseDisconnectTbotHotspot': 'Bitte trennen Sie sich vom tbot Hotspot',
  ...
  'deviceConfig.phoneConnectTbotHotspot': 'Telefon mit tbot Hotspot verbinden',
