...
export default {
  ...
  'device.editProfile': '编辑',
  'device.editProfileTitle': '设备和儿童资料',
  'device.deviceName': '设备名称',
  'device.deviceNamePlaceholder': '例如：卧室机器人',
  'device.childProfile': '儿童资料',
  'device.childName': '儿童姓名',
  'device.childNamePlaceholder': '请输入儿童姓名',
  'device.childAge': '儿童年龄',
  'device.childAgePlaceholder': '1-18',
  'device.childAgeInvalid': '年龄必须是 1 到 18 的整数',
  'device.childSummaryWithAge': '{name}，{age}岁',
  'device.childNotSet': '未设置儿童姓名',
  'device.saveProfile': '保存资料',
  'device.profileSaveSuccess': '资料已保存',
  'device.profileSaveFailed': '保存资料失败',
  ...
  'settings.validServerUrl': '请输入有效的服务端地址（以 http 或 https 开头，并以 /tbot 结尾）',
  ...
  // 关于我们
  'settings.aboutApp': '关于 TBOT',
  'settings.aboutContent': 'TBOT\n\n基于 Vue.js 3 + uni-app 构建的跨平台移动端管理应用，为 TBOT ESP32 智能硬件提供设备管理、智能体配置等功能。\n\n© 2025 tbot-esp32-server {version}',
  ...
  'deviceConfig.connectToTbotHotspot': '请先连接tbot热点 (tbot-XXXXXX)',
  'deviceConfig.detecting': '检测中...',
  'deviceConfig.reDetect': '重新检测',
  'deviceConfig.alreadyConnected': '已连接tbot热点',
  ...
  'deviceConfig.bringPhoneCloseToTbotDevice': '将手机靠近tbot设备（距离1-2米）',
  'deviceConfig.duringAudioPlaybackTbotWillReceive': '音频播放时，tbot会接收并解码配网信息',
  ...
  'deviceConfig.connectTbotHotspot': '请连接tbot热点',
  ...
  'deviceConfig.connectedTbotHotspot': '已连接tbot热点',
  ...
  'deviceConfig.pleaseDisconnectTbotHotspot': '请断开tbot热点连接',
  ...
  'deviceConfig.phoneConnectTbotHotspot': '手机连接tbot热点',
