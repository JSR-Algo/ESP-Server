...
export default {
  ...
  'device.editProfile': 'Chỉnh sửa',
  'device.editProfileTitle': 'Thiết bị và hồ sơ trẻ',
  'device.deviceName': 'Tên thiết bị',
  'device.deviceNamePlaceholder': 'Ví dụ: Robot phòng ngủ',
  'device.childProfile': 'Hồ sơ trẻ',
  'device.childName': 'Tên trẻ',
  'device.childNamePlaceholder': 'Nhập tên trẻ',
  'device.childAge': 'Tuổi của trẻ',
  'device.childAgePlaceholder': '1-18',
  'device.childAgeInvalid': 'Tuổi phải là số từ 1 đến 18',
  'device.childSummaryWithAge': '{name}, {age} tuổi',
  'device.childNotSet': 'Chưa đặt tên trẻ',
  'device.saveProfile': 'Lưu hồ sơ',
  'device.profileSaveSuccess': 'Đã lưu hồ sơ',
  'device.profileSaveFailed': 'Lưu hồ sơ thất bại',
  ...
  'settings.validServerUrl': 'Vui lòng nhập địa chỉ máy chủ hợp lệ (bắt đầu bằng http hoặc https và kết thúc bằng /tbot)',
  ...
  // Về chúng tôi
  'settings.aboutApp': 'Về Bảng điều khiển TBot',
  'settings.aboutContent': 'Bảng điều khiển TBot\n\nỨng dụng quản lý di động đa nền tảng được xây dựng với Vue.js 3 + uni-app, cung cấp quản lý thiết bị, cấu hình đại lý và các chức năng khác cho phần cứng thông minh tbot ESP32.\n\n© 2025 tbot-esp32-server {version}',
  ...
  'deviceConfig.connectToTbotHotspot': 'Vui lòng kết nối với điểm phát sóng tbot trước',
  'deviceConfig.detecting': 'Đang phát hiện...',
  'deviceConfig.reDetect': 'Phát hiện lại',
  'deviceConfig.alreadyConnected': 'Đã kết nối với điểm phát sóng tbot',
  ...
  'deviceConfig.bringPhoneCloseToTbotDevice': 'Đưa điện thoại lại gần thiết bị tbot (khoảng cách 1-2 mét)',
  'deviceConfig.duringAudioPlaybackTbotWillReceive': 'Trong khi phát âm thanh, tbot sẽ nhận và giải mã thông tin cấu hình',
  ...
  'deviceConfig.connectTbotHotspot': 'Vui lòng kết nối với điểm phát sóng tbot',
  ...
  'deviceConfig.connectedTbotHotspot': 'Đã kết nối với điểm phát sóng tbot',
  ...
  'deviceConfig.pleaseDisconnectTbotHotspot': 'Vui lòng ngắt kết nối khỏi điểm phát sóng tbot',
  ...
  'deviceConfig.phoneConnectTbotHotspot': 'Điện thoại kết nối với điểm phát sóng tbot',
