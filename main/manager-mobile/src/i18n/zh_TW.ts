...
export default {
  ...
  'device.editProfile': '編輯',
  'device.editProfileTitle': '設備和兒童資料',
  'device.deviceName': '設備名稱',
  'device.deviceNamePlaceholder': '例如：臥室機器人',
  'device.childProfile': '兒童資料',
  'device.childName': '兒童姓名',
  'device.childNamePlaceholder': '請輸入兒童姓名',
  'device.childAge': '兒童年齡',
  'device.childAgePlaceholder': '1-18',
  'device.childAgeInvalid': '年齡必須是 1 到 18 的整數',
  'device.childSummaryWithAge': '{name}，{age}歲',
  'device.childNotSet': '未設定兒童姓名',
  'device.saveProfile': '保存資料',
  'device.profileSaveSuccess': '資料已保存',
  'device.profileSaveFailed': '保存資料失敗',
  ...
  'settings.validServerUrl': '請輸入有效的服務端地址（以 http 或 https 開頭，並以 /tbot 結尾）',
  ...
  // 關於我們
  'settings.aboutApp': '關於 TBOT',
  'settings.aboutContent': 'TBOT\n\n基於 Vue.js 3 + uni-app 構建的跨平台移動端管理應用，為 TBOT ESP32 智能硬體提供設備管理、智能體配置等功能。\n\n© 2025 tbot-esp32-server {version}',
  ...
  'deviceConfig.connectToTbotHotspot': '請先連接tbot熱點 (tbot-XXXXXX)',
  'deviceConfig.detecting': '檢測中...',
  'deviceConfig.reDetect': '重新檢測',
  'deviceConfig.alreadyConnected': '已連接tbot熱點',
  ...
  'deviceConfig.bringPhoneCloseToTbotDevice': '將手機靠近tbot設備（距離1-2米）',
  'deviceConfig.duringAudioPlaybackTbotWillReceive': '音頻播放時，tbot會接收並解碼配網信息',
  ...
  'deviceConfig.connectTbotHotspot': '請連接tbot熱點',
  ...
  'deviceConfig.connectedTbotHotspot': '已連接tbot熱點',
  ...
  'deviceConfig.pleaseDisconnectTbotHotspot': '請斷開tbot熱點連接',
  ...
  'deviceConfig.phoneConnectTbotHotspot': '手機連接tbot熱點',
