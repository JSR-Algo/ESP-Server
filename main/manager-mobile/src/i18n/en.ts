...
export default {
  ...
  'device.editProfile': 'Edit',
  'device.editProfileTitle': 'Device and Child Profile',
  'device.deviceName': 'Device name',
  'device.deviceNamePlaceholder': 'Example: Bedroom robot',
  'device.childProfile': 'Child profile',
  'device.childName': 'Child name',
  'device.childNamePlaceholder': 'Enter child name',
  'device.childAge': 'Child age',
  'device.childAgePlaceholder': '1-18',
  'device.childAgeInvalid': 'Age must be a number from 1 to 18',
  'device.childSummaryWithAge': '{name}, age {age}',
  'device.childNotSet': 'Child name not set',
  'device.saveProfile': 'Save profile',
  'device.profileSaveSuccess': 'Profile saved',
  'device.profileSaveFailed': 'Failed to save profile',
  ...
  'settings.validServerUrl': 'Please enter a valid server address (starting with http or https and ending with /tbot)',
  ...
  // About us
  'settings.aboutApp': 'About TBot Console',
  'settings.aboutContent': 'TBot Console\n\nA cross-platform mobile management app built with Vue.js 3 + uni-app, providing device management, agent configuration and other functions for tbot ESP32 smart hardware.\n\n© 2025 tbot-esp32-server {version}',
  ...
  'deviceConfig.connectToTbotHotspot': 'Please connect to tbot hotspot first',
  'deviceConfig.detecting': 'Detecting...',
  'deviceConfig.reDetect': 'Re-detect',
  'deviceConfig.alreadyConnected': 'Connected to tbot hotspot',
  ...
  'deviceConfig.bringPhoneCloseToTbotDevice': 'Bring phone close to tbot device (1-2 meters distance)',
  'deviceConfig.duringAudioPlaybackTbotWillReceive': 'During audio playback, tbot will receive and decode configuration information',
  ...
  'deviceConfig.connectTbotHotspot': 'Please connect to tbot hotspot',
  ...
  'deviceConfig.connectedTbotHotspot': 'Connected to tbot hotspot',
  ...
  'deviceConfig.pleaseDisconnectTbotHotspot': 'Please disconnect from tbot hotspot',
  ...
  'deviceConfig.phoneConnectTbotHotspot': 'Phone connect to tbot hotspot',
