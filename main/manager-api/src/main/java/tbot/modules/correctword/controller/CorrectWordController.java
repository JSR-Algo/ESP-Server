package tbot.modules.correctword.controller;
...
public class CorrectWordController {
    ...
    @PostMapping("/file")
    @Operation(summary = "Create replacement word file")
    ...
    @Operation(summary = "Modify replacement word file")
    @RequiresPermissions("sys:role:normal")
    ...
    @Operation(summary = "Paginated get current user's replacement word file list")
    @RequiresPermissions("sys:role:normal")
    @Parameters({
    ...
    @Operation(summary = "Agent gets current user's replacement word file list")
    @RequiresPermissions("sys:role:normal")
    ...
    @Operation(summary = "Download replacement word file")
    @RequiresPermissions("sys:role:normal")
    ...
    @Operation(summary = "DeleteReplacement wordFile")
    @RequiresPermissions("sys:role:normal")
    ...
    @Operation(summary = "BatchDeleteReplacement wordFile")
    @RequiresPermissions("sys:role:normal")
