...
INSERT INTO `sys_params` (id, param_code, param_value, value_type, param_type, remark) VALUES (106, 'server.websocket', 'wss://esp.tjbot.vn/tbot/v1/', 'string', 1, 'websocket地址，多个用;分隔');

delete from `sys_params` where id = 107;
INSERT INTO `sys_params` (id, param_code, param_value, value_type, param_type, remark) VALUES (107, 'server.ota', 'https://esp.tjbot.vn/tbot/ota/', 'string', 1, 'ota地址');
