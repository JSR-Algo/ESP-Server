...
INSERT INTO `sys_params` (id, param_code, param_value, value_type, param_type, remark) VALUES (104, 'server.fronted_url', 'https://admin.tjbot.vn', 'string', 1, '下发六位验证码时显示的控制面板地址');
