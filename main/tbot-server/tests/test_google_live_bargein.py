...
class BargeInConfigTuneTest(unittest.TestCase):
    ...
    def test_config_yaml_barge_in_thresholds_match_pr4_tune(self):
        ...
        self.assertEqual(google_live["wake_audio_allow_window_sec"], 900)
    ...
    def test_google_live_defaults_match_pr4_tune(self):
        ...
        self.assertEqual(GOOGLE_LIVE_DEFAULTS["wake_audio_allow_window_sec"], 900)
        ...
        self.assertEqual(GOOGLE_LIVE_DEFAULTS["mute_input_after_audio_start_sec"], 0.4)
        self.assertEqual(GOOGLE_LIVE_DEFAULTS["echo_tail_suppression_ms"], 500)
        self.assertEqual(GOOGLE_LIVE_DEFAULTS["echo_tail_extend_rms_threshold"], 700)
        self.assertEqual(GOOGLE_LIVE_DEFAULTS["echo_tail_extend_ms"], 300)
        self.assertEqual(GOOGLE_LIVE_DEFAULTS["echo_tail_max_total_ms"], 1200)
