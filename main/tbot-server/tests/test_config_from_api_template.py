...
def test_manager_api_template_exposes_tbot_connect_public_endpoints():
    ...
    assert server["websocket"] == "wss://perform-elvis-specifically-nominated.trycloudflare.com/tbot/v1/"
    ...
    assert server["vision_explain"] == "https://luggage-spears-louisville-psychology.trycloudflare.com/mcp/vision/explain"
