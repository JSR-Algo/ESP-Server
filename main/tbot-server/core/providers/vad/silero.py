...
class VADProvider(VADProviderBase):
    ...
    def _init_connection_state(self, conn):
        """Initialize independent VAD state for connection"""
    ...
    def release_conn_resources(self, conn):
        """Release connection VAD resources (called when connection closes)"""
    ...
    def is_vad(self, conn, opus_packet):
        # Manual mode: return directlyTrue,no real-timeVADDetection, all audio cached
        ...
        try:
            ...
            while len(conn.client_audio_buffer) >= 512 * 2:
                ...
                # VoiceIf not below minimum, continue previousStatus, judged as hasVoice
                ...
                # If previously hadVoice,but none this timeVoice,and differs from lastVoicetime difference has exceeded silence threshold, then consider one sentence finished
