...
def get_string_no_punctuation_or_emoji(s):
    """Remove spaces, punctuation, and emojis from start and end of string"""
    chars = list(s)
    # Process leading chars
    start = 0
...
def is_punctuation_or_emoji(char):
    """Check whether character is space, specified punctuation, or emoji"""
...
async def get_emotion(conn: "ConnectionHandler", text):
    ...
    try:
        ...
        conn.logger.bind(tag=TAG).warning(f"Send emotion emoji failed, error:{e}")
    return
