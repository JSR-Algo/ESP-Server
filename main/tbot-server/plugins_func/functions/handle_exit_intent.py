    ...
    "function": {
        ...
        "parameters": {
            ...
            "properties": {
                "say_goodbye": {
                    "type": "string",
                    "description": "and user-friendly farewell to end conversation",
                }
            },
...
def handle_exit_intent(conn: "ConnectionHandler", say_goodbye: str | None = None):
    ...
    try:
        if say_goodbye is None:
            say_goodbye = "Goodbye, wish you happy life!"
        ...
        logger.bind(tag=TAG).error(f"Handle exit intent error: {e}")
        return ActionResponse(
