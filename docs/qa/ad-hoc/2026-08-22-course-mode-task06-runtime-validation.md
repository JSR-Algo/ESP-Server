...
| Reliability/resource trend | 60-second bounded wall-clock soak with tracemalloc, FD, thread, and process metrics | PASS: thread delta 0, FD delta 0, heap current delta 544 B against a 1 MiB fail-closed bound, heap peak 5,240 B, max RSS 71,172,096 B |
