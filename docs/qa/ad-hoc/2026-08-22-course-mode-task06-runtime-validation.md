...
| --- | --- | --- |
| Deterministic full sessions | `python3 scripts/course_mode_task06_runtime_validation.py --backend-root ... --firmware-root ... --iterations 2000 --min-duration-seconds 60 --output .../metrics/runtime-soak-60s.json` | PASS: 22 scenario types, 159,407 iterations, 3,506,954 sessions, 60.000052 s, zero mismatches |
...
| Reliability/resource trend | 60-second bounded wall-clock soak with tracemalloc, FD, thread, and process metrics | PASS: thread delta 0, FD delta 0, heap current delta 208 B, heap peak 4,880 B, max RSS 32,751,616 B |
