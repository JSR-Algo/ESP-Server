...
validate_production_boot_env() {
  ...
  local lesson_runtime lesson_sample lesson_renderer_v2 lesson_renderer_v4 lesson_renderer_v5 lesson_motion lesson_playful rollout_allowlist rollout_count
  ...
  for key in LESSON_RUNTIME_ENABLED LESSON_SAMPLE_ENABLED LESSON_RENDERER_V2_ENABLED LESSON_RENDERER_V4_ENABLED LESSON_RENDERER_V5_ENABLED LESSON_MOTION_PRESETS_ENABLED LESSON_PLAYFUL_INTERACTIONS_ENABLED; do
